...
from agent_c.util.segmentation.segmenters.centric_elements import *
...
class _DocxPartitioner:
    ...
    def _style_based_element_type(self, paragraph: Paragraph) -> Type[Text] | None:
        ...
        STYLE_TO_ELEMENT_MAPPING = {
            ...
            "List Continue": ListContinue,
            "List Continue 2": ListContinue2,
            "List Continue 3": ListContinue3,
