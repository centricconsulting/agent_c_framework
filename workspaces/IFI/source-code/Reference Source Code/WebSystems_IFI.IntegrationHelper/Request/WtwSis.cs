...
{
    public class WtwSis : VendorRequest
    {
        ...
        public WtwSis(string API_Address, string apiKey) : base(API_Address, apiKey, "rating", "wtwsis") { }
        public WtwSis(string API_Address, string apiKey, bool useLibraryValidation) : base(API_Address, apiKey, "rating", "wtwsis", useLibraryValidation) { }
        ...
        public ServiceResult<Response.WtwSis> GetVendorData()
        {
            ValidateRequest();

            return SendRequestForListResponse<IEnumerable<ServiceResult<Response.WtwSis>>>(InternalEnums.TransType.Post, this)?.FirstOrDefault();
        }

        public async Task<ServiceResult<Response.WtwSis>> GetVendorData_Async()
        {
            ValidateRequest();

            var response = await SendRequestForListResponse_Async<IEnumerable<ServiceResult<Response.WtwSis>>>(InternalEnums.TransType.Post, this);
