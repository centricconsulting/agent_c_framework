...
{
    public class BetterView : VendorRequest
    {
        ...
        public BetterView(string API_Address, string apiKey) : base(API_Address, apiKey, "rating", "betterview") { }

        public BetterView(string API_Address, string apiKey, bool useLibraryValidation) : base(API_Address, apiKey, "rating", "betterview", useLibraryValidation) { }
        ...
        public ServiceResult<Response.BetterView> GetVendorData()
        {
            ValidateRequest();

            return SendRequestForListResponse<IEnumerable<ServiceResult<Response.BetterView>>>(InternalEnums.TransType.Post, this)?.FirstOrDefault();
        }

        public async Task<ServiceResult<Response.BetterView>> GetVendorData_Async()
        {
            ValidateRequest();

            var response = await SendRequestForListResponse_Async<IEnumerable<ServiceResult<Response.BetterView>>>(InternalEnums.TransType.Post, this);
