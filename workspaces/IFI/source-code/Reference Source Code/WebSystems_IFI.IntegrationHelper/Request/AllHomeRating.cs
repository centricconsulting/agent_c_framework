...
{
    public class AllHomeRating : VendorRequest
    {
        ...
        public AllHomeRating(string API_Address, string apiKey) : base(API_Address, apiKey, "rating", "allhomerating") { }

        public AllHomeRating(string API_Address, string apiKey, bool useLibraryValidation) : base(API_Address, apiKey, "rating", "allhomerating", useLibraryValidation) { }
        ...
        public ServiceResult<Response.AllHomeRating> GetVendorData()
        {
            ValidateRequest();

            return SendRequestForListResponse<IEnumerable<ServiceResult<Response.AllHomeRating>>>(InternalEnums.TransType.Post, this)?.FirstOrDefault();
        }

        public async Task<ServiceResult<Response.AllHomeRating>> GetVendorData_Async()
        {
            ValidateRequest();

            var response = await SendRequestForListResponse_Async<IEnumerable<ServiceResult<Response.AllHomeRating>>>(InternalEnums.TransType.Post, this);
