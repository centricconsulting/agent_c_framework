Public Class DiamondClaims_FNOL_Witness 'Don Mink - added 4/26/2013
    Inherits DiamondClaims_FNOL_Person
    Implements IDisposable

    Private _Remarks As String
    Private _RelationshipId As String
        ...
        If Not Me.disposedValue Then
            If disposing Then
                ...
                If _Remarks IsNot Nothing Then
                    _Remarks = Nothing
                End If
                If _RelationshipId IsNot Nothing Then
                    _RelationshipId = Nothing
                End If
                MyBase.Dispose()
            End If
