<%@ Control Language="VB" AutoEventWireup="false" CodeFile="VRProposal_Disclaimer.ascx.vb" Inherits="controls_Proposal_VRProposal_Disclaimer" %>
<br />
...
<%--<table width="100%" class="quickQuoteSectionTable">
    ...
    <div class="DisclaimerHolder"><div class="QuickQuoteProposalDisclaimer">
        <ul>
            ...
            <li>This quotation is valid for 60 days.</asp:Label></li>
            <li>Additional coverages, exposures, or increased limits may be added for additional premium.</li>
        </ul>
    </div></div>
</div>
