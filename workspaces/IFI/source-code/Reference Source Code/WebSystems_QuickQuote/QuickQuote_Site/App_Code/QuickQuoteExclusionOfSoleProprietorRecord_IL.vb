...
Namespace QuickQuote.CommonObjects
    ''' <summary>
    ''' object used to store exclusion of sole proprietor for IL
    ''' </summary>
    ...
    <Serializable()>
    Public Class QuickQuoteExclusionOfSoleProprietorRecord_IL 'added 10/15/2018
        ...
        Public Property Phones As Generic.List(Of QuickQuotePhone)
            Get
                SetParentOfListItems(_Phones, "{663B7C7B-F2AC-4BF6-965A-D30F41A05213}")
                Return _Phones
            End Get
        ...
        Public Property Emails As Generic.List(Of QuickQuoteEmail)
            Get
                Return _Emails
                SetParentOfListItems(_Emails, "{663B7C7B-F2AC-4BF6-965A-D30F41A05214}")
            End Get
