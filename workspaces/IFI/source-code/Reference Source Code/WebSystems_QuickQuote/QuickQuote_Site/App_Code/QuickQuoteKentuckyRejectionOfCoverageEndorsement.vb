...
Namespace QuickQuote.CommonObjects
    ''' <summary>
    ''' object used to store KY Rejection of Coverage Endorsement
    ''' </summary>
    ...
    <Serializable()>
    Public Class QuickQuoteKentuckyRejectionOfCoverageEndorsement 'added 4/26/2019
        ...
        Public Property Phones As Generic.List(Of QuickQuotePhone)
            Get
                SetParentOfListItems(_Phones, "{663B7C7B-F2AC-4BF6-965A-D30F41A05215}")
                Return _Phones
            End Get
        ...
        Public Property Emails As Generic.List(Of QuickQuoteEmail)
            Get
                Return _Emails
                SetParentOfListItems(_Emails, "{663B7C7B-F2AC-4BF6-965A-D30F41A05216}")
            End Get
        ...
        Private Sub SetDefaults()
            ...
            _Emails = Nothing
            _PositionTitleTypeId = "" 'note: not defaulting to Officer like IN version does; would need to update HasData below to also look for value <> 5 if we put defaulting back in
        End Sub
