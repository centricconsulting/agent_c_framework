...
Namespace QuickQuote.CommonObjects 'added namespace 12/20/2013
    ''' <summary>
    ''' object used to store agency information
    ''' </summary>
    ''' <remarks></remarks>
    <Serializable()> _
    Public Class QuickQuoteAgency 'added 5/1/2013
        ...
        Public Property Phones As Generic.List(Of QuickQuotePhone)
            Get
                SetParentOfListItems(_Phones, "{32BB5FB9-093F-42E5-8373-3CB836D45A44}")
                Return _Phones
            End Get
        ...
        Public Property Emails As Generic.List(Of QuickQuoteEmail)
            Get
                SetParentOfListItems(_Emails, "{32BB5FB9-093F-42E5-8373-3CB836D45A45}")
                Return _Emails
            End Get
