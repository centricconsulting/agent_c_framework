...
Namespace QuickQuote.CommonObjects
    ''' <summary>
    ''' object used to store static data attribute
    ''' </summary>
    ''' <remarks>used w/ Static Data xml file(s)</remarks>
    <Serializable()> _
    Public Class QuickQuoteStaticDataAttribute 'added 8/15/2014
        Public Property NameValuePair As QuickQuoteStaticDataNameValuePair = Nothing
        Public Property ValidNameValuePairs As List(Of QuickQuoteStaticDataNameValuePair) = Nothing 'added 9/28/2021
