...
Namespace QuickQuote.CommonObjects 'added namespace 12/20/2013
    ''' <summary>
    ''' object used to store requestor identification information
    ''' </summary>
    ''' <remarks>related to 3rd party information</remarks>
    <Serializable()> _
    Public Class QuickQuoteRequestorIdentification 'added 9/18/2013
        ...
        Protected Overloads Sub Dispose(disposing As Boolean)
            If Not Me.disposedValue Then
                If disposing Then
                    ...
                    End If
                    If _RequestorName IsNot Nothing Then
                        _RequestorName = Nothing
                    End If
