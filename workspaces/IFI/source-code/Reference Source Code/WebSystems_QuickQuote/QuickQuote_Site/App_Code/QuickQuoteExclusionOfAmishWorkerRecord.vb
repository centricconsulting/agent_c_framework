...
Namespace QuickQuote.CommonObjects 'added namespace 12/20/2013
    ''' <summary>
    ''' object used to store exclusion of amish worker
    ''' </summary>
    ...
    <Serializable()> _
    Public Class QuickQuoteExclusionOfAmishWorkerRecord
        ...
        Public Property Phones As Generic.List(Of QuickQuotePhone)
            Get
                SetParentOfListItems(_Phones, "{663B7C7B-F2AC-4BF6-965A-D30F41A05209}")
                Return _Phones
            End Get
        ...
        Public Property Emails As Generic.List(Of QuickQuoteEmail)
            Get
                SetParentOfListItems(_Emails, "{663B7C7B-F2AC-4BF6-965A-D30F41A05210}")
                Return _Emails
            End Get
