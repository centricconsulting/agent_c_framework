...
Namespace QuickQuote.CommonObjects 'added namespace 12/20/2013
    ''' <summary>
    ''' object used to store exclusion of sole proprietor
    ''' </summary>
    ...
    <Serializable()> _
    Public Class QuickQuoteExclusionOfSoleProprietorRecord
        ...
        Public Property Phones As Generic.List(Of QuickQuotePhone)
            Get
                SetParentOfListItems(_Phones, "{663B7C7B-F2AC-4BF6-965A-D30F41A05211}")
                Return _Phones
            End Get
        ...
        Public Property Emails As Generic.List(Of QuickQuoteEmail)
            Get
                Return _Emails
                SetParentOfListItems(_Emails, "{663B7C7B-F2AC-4BF6-965A-D30F41A05212}")
            End Get
