<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctlVehicleAdditionalInterest.ascx.vb" Inherits="IFM.VR.Web.ctlVehicleAdditionalInterest" %>
...
<div runat="server" id="divAiEntry">
    <table style="width: 100%">
        <tr id="trSaveMsgRow" runat="server" visible="false">
            <td colspan="2">
                <span id="spnMsg" runat="server" style="color:red;font-weight:700;">Additional Interests must be saved before they can be selected as Loss Payees in the Building section</span>
            </td>
        </tr>
        <tr>
