<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctlUWQuestions_PPA.ascx.vb" Inherits="IFM.VR.Web.ctlUWQuestions_PPA" ViewStateMode="Enabled" %>
<header>
    <style type="text/css">
        .TableLeftColumn {
            width: 500px;
...
<script type="text/javascript">
    ; (function ($, window) {
        ...
        function UwQuestionAnswered(event) {
            ...
            let neverShowDescription = dataHolder.data('questionNeverShowDescription');
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:RadioButton ID="rbYes" runat="server" Text="Yes" GroupName='<%# Eval("QuestionNumber", "questionNumber{0}")%>' TabIndex="<%# GetTabIndex()%>" Checked='<%# Eval("QuestionAnswerYes") %>'
                                                    ...
                                                    data-question-required='<%# Eval("IsQuestionRequired") %>' 
                                                    data-question-never-show-description='<%# Eval("NeverShowDescription") %>'/>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
