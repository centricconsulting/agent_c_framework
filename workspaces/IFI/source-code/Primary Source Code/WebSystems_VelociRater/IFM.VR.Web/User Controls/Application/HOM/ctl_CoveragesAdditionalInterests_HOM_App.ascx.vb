...
Public Class ctl_CoveragesAdditionalInterests_HOM_App
            ...
            If (Me.Quote.LobType = QuickQuote.CommonObjects.QuickQuoteObject.QuickQuoteLobType.HomePersonal AndAlso HomeVersion = "After20180701" AndAlso Me.Quote.Locations(0).FormTypeId.EqualsAny("22", "23", "24", "25", "26")) Then
                If showAIOnAppGap = True Then
                    ...
                    If MySectionCoverage Is Nothing Then
                        Me.VRScript.CreateAccordion(Me.divAICoverageMain.ClientID, Nothing, "false")
                        divAICoverageContent.Visible = False
                    Else
                        divAICoverageMain.Visible = True
                        divAICoverageContent.Visible = True
                        hiddenAICoverageAccordActive.Value = "0" 'expand
                        Me.VRScript.CreateAccordion(Me.divAICoverageMain.ClientID, Me.hiddenAICoverageAccordActive, "0")
                        If isFirstOfMultiple = False Then
                            lblHeader.Visible = True
                            lblHeader.Text = ""
                            Me.VRScript.AddScriptLine("$(""#" + divAICoverageMain.ClientID + """).accordion({icons: false});")
        ...
        If Me.Quote IsNot Nothing Then
            If (Me.Quote.LobType = QuickQuote.CommonObjects.QuickQuoteObject.QuickQuoteLobType.HomePersonal AndAlso HomeVersion = "After20180701" AndAlso Me.Quote.Locations(0).FormTypeId.EqualsAny("22", "23", "24", "25", "26")) Then
                ...
                If showAIOnAppGap = True Then
                    ...
                    Me.ctl_CoverageAddress_HOM_App_Item.CoverageName = Me.CoverageName
                    Me.ctl_CoverageAddress_HOM_App_Item.AdditionalInterestIndex = Me.AdditionalInterestIndex
                ...
                If showAIOnAppGap = True Then
                    Select Case SectionCoverageIAndIIEnum
                        Case QuickQuoteSectionIAndIICoverage.SectionIAndIICoverageType.AdditionalInsured_StudentLivingAwayFromResidence
                            ...
                            divAIAddress.Visible = True
                            txtName.Enabled = False
                            txtDescription.Enabled = False
                            txtName.BackColor = Drawing.Color.WhiteSmoke 'LightGray
                            txtName.ForeColor = Drawing.Color.Black
                            txtDescription.BackColor = Drawing.Color.WhiteSmoke 'LightGray
                            txtDescription.ForeColor = Drawing.Color.Black
                            lblName.Text = "Name of Student"
                            lblDescription.Text = "Name of School"
                            txtName.Text = MySectionCoverage.AdditionalInterests(AdditionalInterestIndex).Name.CommercialName1
                            txtDescription.Text = MySectionCoverage.AdditionalInterests(AdditionalInterestIndex).Description
                            Me.ctl_CoverageAddress_HOM_App_Item.CoverageIndex = Me.CoverageIndex
                            Me.ctl_CoverageAddress_HOM_App_Item.AdditionalInterestIndex = Me.AdditionalInterestIndex
                            Me.ctl_CoverageAddress_HOM_App_Item.appGapAIStatusList = appGapAIStatusList
                            Me.ctl_CoverageAddress_HOM_App_Item.SectionCoverageIAndIIEnum = MySectionCoverage.CoverageType
                        ...
                        Case QuickQuoteSectionIAndIICoverage.SectionIAndIICoverageType.TrustEndorsement
                            ...
                            txtTrustName.BackColor = Drawing.Color.WhiteSmoke 'LightGray
                            txtTrustName.ForeColor = Drawing.Color.Black
                            If MySectionCoverage.AdditionalInterests(AdditionalInterestIndex).TypeId = "79" Then
                                txtTrustName.Text = ReturnCommercialName(MySectionCoverage.AdditionalInterests(AdditionalInterestIndex).Name.CommercialName1)
                            Else
                                If MyAiTrustList IsNot Nothing AndAlso MyAiTrustList.Any() Then
                                    txtTrustName.Text = ReturnCommercialName(MyAiTrustList(0).Name.CommercialName1)
                                End If
                                divTrustee.Visible = True
                                txtTrusteeName.Enabled = False
                                txtTrusteeName.BackColor = Drawing.Color.WhiteSmoke 'LightGray
                                txtTrusteeName.ForeColor = Drawing.Color.Black
                                txtTrusteeName.Text = ReturnCommercialName(MySectionCoverage.AdditionalInterests(AdditionalInterestIndex).Name.CommercialName1)
                            End If
