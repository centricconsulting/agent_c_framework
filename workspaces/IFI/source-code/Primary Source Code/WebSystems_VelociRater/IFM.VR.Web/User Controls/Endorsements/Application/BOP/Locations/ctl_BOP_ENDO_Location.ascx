<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctl_BOP_ENDO_Location.ascx.vb" Inherits="IFM.VR.Web.ctl_BOP_ENDO_Location" %>
<%@ Register Src="~/User Controls/QuoteEdit/HOM/Property/ctlProperty_Address.ascx" TagPrefix="uc1" TagName="ctlProperty_Address" %>
<%@ Register Src="~/User Controls/Endorsements/Application/BOP/Locations/Buildings/ctl_BOP_ENDO_BuildingList.ascx" TagPrefix="uc2" TagName="ctl_BOP_ENDO_BuildingList" %>
<%@ Register Src="~/User Controls/Endorsements/Application/BOP/Locations/ctl_BOP_ENDO_Location_Coverages.ascx" TagPrefix="uc1" TagName="ctl_BOP_ENDO_Location_Coverages" %>
...
<div runat="server" id="divContents">
    ...
    <uc1:ctl_BOP_ENDO_Location_Coverages runat="server" id="ctl_BOP_ENDO_Location_Coverages" />
    <uc2:ctl_BOP_ENDO_BuildingList runat="server" ID="ctl_BOP_ENDO_BuildingList" />
