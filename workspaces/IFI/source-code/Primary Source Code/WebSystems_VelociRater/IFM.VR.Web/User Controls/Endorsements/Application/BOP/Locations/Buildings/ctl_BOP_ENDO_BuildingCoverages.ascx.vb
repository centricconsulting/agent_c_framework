...
Public Class ctl_BOP_ENDO_BuildingCoverages
...
#Region "Declarations"
    ...
    ''' </summary>
    ''' <returns></returns>
    ''' 'Removed 11/01/2021 for BOP Endorsements Task 65885 MLW
...
#Region "Methods and Functions"
    ...
    Public Sub ClassificationChanged()
        Quote.CopyProfessionalLiabilityCoveragesFromPolicyToBuildings_UseBuildingClassificationList() 'Added 10/28/2021 for BOP Endorsements Task 65882 MLW
        Populate()
    End Sub
    ...
    Public Overrides Sub Populate()
        ...
        Try
            If Me.Quote IsNot Nothing Then
                ...
                'Added 11/01/2021 for BOP Endorsements Task 65885 MLW
                trProfessionalLiabilityInfoText.Visible = False

                'Quote.CopyProfessionalLiabilityCoveragesFromPolicyToBuildings_UseBuildingClassificationList() 'Removed 10/28/2021 for BOP Endorsements Task 65882 MLW - moved to location list populate to reduce number of copies
                ...
                If Me.Quote.Locations.HasItemAtIndex(LocationIndex) AndAlso Me.Quote.Locations(LocationIndex).Buildings.HasItemAtIndex(BuildingIndex) Then
                    ...
                    chkLiquorLiability.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    txtLiquorLiabiltyAnnualGrossAlcoholSales.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    If BuildingCanHaveOptionalClassCoverage(ClassCoverage_Enum.LiquorLiability, hascov, err) Then
                        trLiquorLiabilityCheckboxRow.Visible = True
                        trLiquorLiabilityCheckboxRow.Attributes.Add("style", "display:''") 'Added 12/31/18 for Bug 30677 MLW
                        trProfessionalLiabilityInfoText.Visible = True 'Added 11/01/2021 for BOP Endorsements Task 65885 MLW
                        ...
                        If hascov Then
                            ...
                            '    'chkLiquorLiability.Enabled = True 'moved above 11/01/2021 MLW
                            ...
                            '    'chkLiquorLiability.Enabled = False 'moved above 11/01/2021 MLW
                        ...
                        Select Case MyLocation.Address.QuickQuoteState
                            Case QuickQuote.CommonMethods.QuickQuoteHelperClass.QuickQuoteState.Illinois
                                ...
                                'chkLiquorLiability.InputAttributes.Add("class", "chkLiquorSelector_IL")
                            ...
                            Case QuickQuote.CommonMethods.QuickQuoteHelperClass.QuickQuoteState.Indiana
                                ...
                                'chkLiquorLiability.InputAttributes.Add("class", "chkLiquorSelector_IN")
                    ...
                    chkFineArts.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    If BuildingCanHaveOptionalClassCoverage(ClassCoverage_Enum.FineArts, hascov, err) Then
                        ...
                        ElseIf AnyBuildingOnStateHasPLCoverage(ClassCoverage_Enum.FineArts) Then
                            ...
                            'End If
                        Else
                            'chkFineArts.Enabled = True 'moved above 11/01/2021 MLW
                    ...
                    chkRestaurant.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    If BuildingCanHaveOptionalClassCoverage(ClassCoverage_Enum.Restaurant, hascov, err) Then
                        ...
                        trProfessionalLiabilityInfoText.Visible = True 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                        ddlRestaurantsLimitOfLiability.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                        ddlRestaurantsDeductible.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                        If hascov Then
                        ...
                        ElseIf AnyBuildingOnStateHasPLCoverage(ClassCoverage_Enum.Restaurant) Then
                            ...
                            '    'chkRestaurant.Enabled = True 'moved above 11/01/2021 MLW
                            '    ddlRestaurantsLimitOfLiability.Enabled = True
                            '    ddlRestaurantsDeductible.Enabled = True
                            'Else
                            '    'chkRestaurant.Enabled = False 'moved above 11/01/2021 MLW
                    ...
                    chkPharmacists.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    txtPharmacistsReceipts.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    ...
                    chkOpticalAndHearingAid.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    txtOpticalAndHearingNumOfEmployees.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    ...
                    chkBarbersLiability.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    txtBarberFullTimeEmployees.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    txtBarberPartTimeEmployees.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    ...
                    chkBeautyShops.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    txtBeautyShopsNumFullTimeEmployees.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    txtBeautyShopsNumPartTimeEmployees.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    ...
                    chkPrinters.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    txtPrintersNumOfLocations.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    ...
                    chkFuneralDirectors.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    txtFuneralNumOfEmployees.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    ...
                    chkPhotography.Enabled = False 'Added 10/28/2021 for BOP Endorsements Task 65882 MLW - do not ever allow users to check or uncheck this coverage on endorsements.
                    If BuildingCanHaveOptionalClassCoverage(ClassCoverage_Enum.Photography, hascov, err) Then
                        ...
                        If hascov Then
                            ...
                            trPhotogScheduledItems.Visible = False
                            If MyBuilding.HasPhotographyCoverageScheduledCoverages Then
                                chkPhotographyScheduledEquipment.Checked = True
                                'Updated 10/28/2021 for BOP Endorsements Task 65882 MLW
                                If BuildingIsFirstOnStateQuoteWithProfessionalLiabilityCoverage(ClassCoverage_Enum.Photography, err) Then
                                    trPhotogScheduledItems.Visible = True 'only show once on first building with coverage. After that just show the limit, but not editable.
                                Else
                                    trPhotogScheduledEquipmentRow.Attributes.Add("style", "display:''") 'Not showing since total shows in photog scheduled equipment control
                                    ...
                                    Next
                                    txtPhotogScheduledEquipmentLimit.Text = Format(tot, "##########")
                    ...
                    chkSelfStorage.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    txtStorageLimit.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    ...
                    chkVeterinarians.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    txtVeterinariansNumOfEmployees.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    ...
                    chkMotel.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    ddlMotelLiabilityLimit.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    ddlMotelSafeDepositBoxDeductible.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    ddlMotelSafeDepositBoxLimit.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    ...
                    chkApartments.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    txtAptsNumberOfLocationsWithApts.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    ddlAptAutoLiabilityLimit.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    ddlAptDeductible.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
                    ...
                    chkResidentialCleaning.Enabled = False 'Updated 11/01/2021 for BOP Endorsements Task 65885 MLW
    ...
    Private Function BuildingCanHaveOptionalClassCoverage(ByVal CovType As ClassCoverage_Enum, ByRef HasCoverage As Boolean, ByRef err As String) As Boolean
        ...
        Try
            ...
            If MyBuilding IsNot Nothing Then
                'Quote.CopyProfessionalLiabilityCoveragesFromPolicyToBuildings_UseBuildingClassificationList() 'Removed 10/28/2021 for BOP Endorsements Task 65882 MLW - was in populate already, do not need extra copying here
                ' Get the class codes we want to check for based on the passed coverage type
                Select Case CovType
                    Case ClassCoverage_Enum.Apartments
                        ' Apartment Class Codes
            ...
            If Me.Quote IsNot Nothing Then
                ...
                If Not endorsementsPreexistHelper.IsPreexistingLocation(LocationIndex) Then
                    If Me.MyBuilding IsNot Nothing Then
                        ...
                        'Quote.CopyProfessionalLiabilityCoveragesFromBuildingsToPolicy_UseBuildingClassificationList() 'Removed 10/28/2021 for BOP Endorsements Task 65882 MLW - moved to location list save
                    End If
                End If
            End If

            'Populate()  ' Watch the values each time this gets hit 'Removed 10/28/2021 for BOP Endorsements task 65882 MLW - no longer need the populate here
    ...
    ''' </summary>
    ''' <param name="CovType"></param>
    ''' 'No longer used on endorsements 11/01/2021 MLW
