<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctl_BOP_ENDO_BuildingCoverages.ascx.vb" Inherits="IFM.VR.Web.ctl_BOP_ENDO_BuildingCoverages" %>
<%@ Register Src="~/User Controls/Endorsements/CommonControls/ctl_ENDO_App_PhotographersEquipment.ascx" TagPrefix="uc2" TagName="ctl_ENDO_PhotographersEquipment" %>
...
<div runat="server" id="divMain">
    ...
    <div>
        <table id="tblOptionalBuildingCoverages" runat="server">
                ...
                <td>
                    <table id="tblPhotography" runat="server" style="width:100%;">
                        ...
                        <tr id="trPhotogScheduledItems" runat="server">
                            <td></td>
                            <td colspan="2">
                                <uc2:ctl_ENDO_PhotographersEquipment runat="server" ID="ctl_ENDO_PhotogEquip" />
                            </td>
                        </tr>
                        <tr>
            ...
            <tr>
                <td id="trProfessionalLiabilityInfoText" class="informationalTextRed" runat="server">If you are adding a location and need to update photography scheduled items, 
                    annual liquor receipts, or employees for the professional liability for the new location please contact your underwriter.</td>
            </tr>
            <tr><td >&nbsp;</td></tr>
            <tr>
