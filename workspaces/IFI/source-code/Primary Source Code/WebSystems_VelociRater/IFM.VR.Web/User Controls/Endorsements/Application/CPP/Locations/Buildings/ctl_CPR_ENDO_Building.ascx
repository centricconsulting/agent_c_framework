<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctl_CPR_ENDO_Building.ascx.vb" Inherits="IFM.VR.Web.ctl_CPR_ENDO_Building" %>
...
<%@ Register Src="~/User Controls/Endorsements/Application/BOP/Locations/Buildings/ctl_BOP_ENDO_App_Building.ascx" TagPrefix="uc1" TagName="ctl_BOP_ENDO_App_Building" %>
...
<div>  
    ...
    <div id="divClassCodeLookup" class="classcode"  runat="server">
        ...
        <uc1:ctl_CCBLookup ID="ctl_CPR_ENDO_ClassCodeLookup" runat="server" />
        <uc1:ctl_EarthquakeCCLookup ID="ctl_CPR_ENDO_PPC_EQCCLookup" runat="server" />  <!-- PPC -->
        <uc1:ctl_EarthquakeCCLookup ID="ctl_CPR_ENDO_PPO_EQCCLookup" runat="server" />  <!-- PPO -->
                ...
                <td>
                    <table style="width:100%;">
                        ...
                        <tr Id="trOwnerOccupiedPercentageRow" runat="server">
                            <td class="CPRBLDG_LabelColumn">Owner Occupied Percentage
                            </td>
                            <td class="CPRBLDG_DataColumn">
                        ...
                        <tr id="trBCWindHailRow" runat="server">
                         ...
                         <tr id="trBCWindHailText" class="informationalText"  runat="server">
                            <td colspan="2">A minimum 1% deductible applies to building coverage for lessors' risk exposures.
                            </td>
                        </tr>
    ...
    <uc1:ctl_BOP_ENDO_App_Building runat="server" ID="ctl_BOP_ENDO_App_Building" />
