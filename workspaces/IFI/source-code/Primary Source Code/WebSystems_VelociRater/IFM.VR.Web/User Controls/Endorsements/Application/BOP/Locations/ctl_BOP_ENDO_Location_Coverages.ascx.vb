...
Public Class ctl_BOP_ENDO_Location_Coverages
            ...
            If Not endorsementsPreexistHelper.IsPreexistingLocation(LocationIndex) Then
                ...
                If chkMoneySecuritiesONPremises.Checked Then
                    If txtMoneySecuritiesONPremisesLimit.Text = String.Empty Then
                        ...
                        Me.ValidationHelper.AddError(txtMoneySecuritiesONPremisesLimit, "Money and Securities/On Premises - Missing Total Limit. Coverage Removed.", accordList)
                    Else
                ...
                If chkMoneySecuritiesOFFPremises.Checked Then
                    If txtMoneySecuritiesOFFPremisesLimit.Text = String.Empty Then
                        ...
                        Me.ValidationHelper.AddError(txtMoneySecuritiesOFFPremisesLimit, "Money and Securities/Off Premises - Missing Total Limit. Coverage Removed.", accordList)
                    Else
                ...
                If chkOutdoorSigns.Checked Then
                    If txtOutdoorSignsLimit.Text = String.Empty Then
                        ...
                        Me.ValidationHelper.AddError(txtOutdoorSignsLimit, "Outdoor Signs - Missing Total Limit. Coverage Removed.", accordList)
                    Else
