<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctl_CPR_ENDO_Location.ascx.vb" Inherits="IFM.VR.Web.ctl_CPR_ENDO_Location" %>
<%@ Register Src="~/User Controls/QuoteEdit/HOM/Property/ctlProperty_Address.ascx" TagPrefix="uc1" TagName="ctlProperty_Address" %>
<%@ Register Src="~/User Controls/Endorsements/Application/CPP/Locations/Buildings/ctl_CPR_ENDO_BuildingList.ascx" TagPrefix="uc1" TagName="ctl_CPR_ENDO_BuildingList" %>
<%@ Register Src="~/User Controls/Endorsements/Application/CPP/Locations/ctl_CPR_ENDO_PropertyInOpenList.ascx" TagPrefix="uc1" TagName="ctl_CPR_ENDO_PropertyInOpenList" %>
<%@ Register Src="~/User Controls/Endorsements/Application/CPP/Locations/ctl_CPR_ENDO_LocationCoverages.ascx" TagPrefix="uc1" TagName="ctl_CPR_ENDO_LocationCoverages" %>
...
<div runat="server" id="divContents" class="parentLocation">
    ...
    <uc1:ctl_CPR_ENDO_LocationCoverages runat="server" id="ctl_LocationCoverages" />
    <uc1:ctl_CPR_ENDO_PropertyInOpenList runat="server" id="ctl_CPR_ENDO_PIO" />
    <uc1:ctl_CPR_ENDO_BuildingList runat="server" id="ctl_CPR_ENDO_BuildingList" />
