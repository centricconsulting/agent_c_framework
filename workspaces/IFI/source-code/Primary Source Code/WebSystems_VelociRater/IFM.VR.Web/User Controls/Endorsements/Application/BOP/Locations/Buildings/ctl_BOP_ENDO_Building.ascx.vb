...
Public Class ctl_BOP_ENDO_Building
    Inherits VRControlBase

    Public ReadOnly Property ScrollToControlId As String
        Get
            Return ctl_BOP_ENDO_Building_Information.MyScrollToID
        End Get
    End Property
    ...
    Public Property LocationIndex As Int32
        ...
        Set(value As Int32)
            ...
            Me.ctl_BOP_ENDO_Building_Information.LocationIndex = value
            Me.ctl_BOP_ENDO_BuildingCoverages.LocationIndex = value
        End Set
    End Property
    ...
    Public Property BuildingIndex As Int32
        ...
        Set(value As Int32)
            ...
            Me.ctl_BOP_ENDO_Building_Information.BuildingIndex = value
            Me.ctl_BOP_ENDO_BuildingCoverages.BuildingIndex = value
        End Set
    End Property
    ...
    Public Sub EffectiveDateChanging(ByVal NewDate As String, ByVal OldDate As String)
        Me.ctl_BOP_ENDO_BuildingCoverages.EffectiveDateChanging(NewDate, OldDate)
        Exit Sub
    End Sub
    ...
    Private Sub ClassificationChanged(ByVal LocNdx As Integer, ByVal BldNdx As Integer, ByVal ClsNdx As Integer, ByVal NewClassCode As String)
        Save()
        Me.ctl_BOP_ENDO_BuildingCoverages.ClassificationChanged()
    End Sub
    ...
    Public Sub HandleAddressChange()
        Me.ctl_BOP_ENDO_Building_Information.Populate()
        Exit Sub
    End Sub

    Public Sub UpdateProtectionClasses()
        Me.ctl_BOP_ENDO_Building_Information.UpdateProtectionClasses()
    End Sub
    ...
    Public Overrides Sub Populate()
        If MyBuilding.IsNotNull Then
            ...
            'Allow entry on classification if one exists.
            If MyBuilding.BuildingClassifications.IsLoaded = False Then
                MyBuilding.BuildingClassifications = New List(Of QuickQuote.CommonObjects.QuickQuoteClassification)
                MyBuilding.BuildingClassifications.AddNew()
            End If



            'ctl_BOP_ENDO_App_Building.Populate()


            'ctl_Endo_AppliedAdditionalInterestList.LocationIndex = Me.LocationIndex
            'ctl_Endo_AppliedAdditionalInterestList.BuildingIndex = Me.BuildingIndex
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        AddHandler Me.ctl_BOP_ENDO_Building_Information.BuildingClassificationChanged, AddressOf ClassificationChanged
    End Sub
