<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctl_CPP_ENDO_App_InlandMarine.ascx.vb" Inherits="IFM.VR.Web.ctl_CPP_ENDO_App_InlandMarine" %>
                        ...
                        <table runat="server" id="tblContractors" style="width:100%">
                            <tr id="trContractorsRow1" runat="server">
                                ...
                                <td class="CPPAppTD3Column">
                                    Valuation
                                    <br />
                                    <asp:DropDownList ID="ddContractorsValuation" runat="server" CssClass="CPPAppDropdown" />
                                       <%-- <asp:ListItem Selected="True" Value="2">Actual Cash Value</asp:ListItem>
...
<%--        <div id="divInstallationFloater" runat="server">
        ...
        <span style="float: right;">
            <asp:LinkButton ID="lbSaveUnScheduledSaveMotorTruckCargo" ToolTip="Save" runat="server" CssClass="RemovePanelLink">Save</asp:LinkButton>
        </span>
            </h3>
            <div>
