...
Public Class ctl_CPR_ENDO_Location
    ...
    Public Property MyLocationIndex As Int32
        ...
        Set(value As Int32)
            ...
            ctl_CPR_ENDO_PIO.LocationIndex = value
            ctl_CPR_ENDO_BuildingList.LocationIndex = value
        End Set
    End Property
    ...
    Public ReadOnly Property TransactionLimitReached As Boolean
        Get
            ...
            If Me.ParentVrControl IsNot Nothing AndAlso TypeOf Me.ParentVrControl Is ctl_CPR_ENDO_LocationList Then
                Dim Parent = CType(ParentVrControl, ctl_CPR_ENDO_LocationList)
    ...
    Public Sub HandleBlanketDeductibleChange()
        Me.ctl_CPR_ENDO_BuildingList.HandleBlanketDeductibleChange()
        Me.ctl_CPR_ENDO_PIO.HandleBlanketDeductibleChange()
    End Sub
    ...
    Public Sub HandleAgreedAmountChange(ByVal newvalue As Boolean)
        Me.ctl_CPR_ENDO_BuildingList.HandleAgreedAmountChange(newvalue)
        Me.ctl_CPR_ENDO_PIO.HandleAgreedAmountChange(newvalue)
    End Sub
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        AddHandler ctl_CPR_ENDO_BuildingList.BuildingZeroDeductibleChanged, AddressOf HandleBuildingZeroDeductibleChange
    ...
    Public Overrides Function Save() As Boolean
        ...
        Select Case Session("CPPCPREventTrigger")
        ...
        CppDictItems.UpdateLocations(DevDictionaryHelper.DevDictionaryHelper.DevDictionaryListType.Add, MyLocation, MyLocationIndex)
    ...
    Protected Sub lnkSave_Click(sender As Object, e As EventArgs) Handles lnkSave.Click
        Session("CPPCPREventTrigger") = "SaveLocationLink"
    ...
    Protected Sub lnkBtnAdd_Click(sender As Object, e As EventArgs) Handles lnkAdd.Click
        Session("CPPCPREventTrigger") = "AddNewLocationLink"
    ...
    Private Sub btnAddBuilding_Click(sender As Object, e As EventArgs) Handles btnAddBuilding.Click
        Me.ctl_CPR_ENDO_BuildingList.buildingControlNewBuildingRequested(MyLocationIndex)
    End Sub
    ...
    Public Overrides Sub EffectiveDateChanged(NewEffectiveDate As String, OldEffectiveDate As String)
        Me.ctl_CPR_ENDO_BuildingList.EffectiveDateChanged(NewEffectiveDate, OldEffectiveDate)
    End Sub
    ...
    Private Sub DisableHeaderLinks(Optional choice As Boolean = True)
        ...
        Me.lnkCopyLocation.Visible = Not choice
