...
Public Class ctl_CPR_ENDO_BuildingList
    ...
    Public Sub HandleBlanketDeductibleChange()
        Dim mybuildings As List(Of ctl_CPR_ENDO_Building) = Me.GatherChildrenOfType(Of ctl_CPR_ENDO_Building)()
        For Each B As ctl_CPR_ENDO_Building In mybuildings
    ...
    Public Overrides Sub Populate()
        If Me.Quote.IsNotNull Then
            If Me.Quote.Locations.HasItemAtIndex(Me.LocationIndex) Then
                ...
                For Each cnt In Me.GatherChildrenOfType(Of ctl_CPR_ENDO_Building)
    ...
    Private Sub ctl_CPR_ENDO_BuildingList_Init(sender As Object, e As EventArgs) Handles Me.Init
    End Sub
    ...
    Protected Sub AttachBuildingControlEvents()
        ...
        For Each cntrl As RepeaterItem In Me.Repeater1.Items
            Dim BldgControl As ctl_CPR_ENDO_Building = cntrl.FindControl("ctl_CPR_ENDO_Building")
    ...
    Public Overrides Sub EffectiveDateChanged(NewEffectiveDate As String, OldEffectiveDate As String)
        For Each ri As RepeaterItem In Repeater1.Items
            Dim ctl As ctl_CPR_ENDO_Building = ri.FindControl("ctl_CPR_ENDO_Building")
