<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctl_CPR_ENDO_LocationCoverages.ascx.vb" Inherits="IFM.VR.Web.ctl_CPR_ENDO_LocationCoverages" %>
...
<div runat="server" id="divCPRLocationCoverages">
    ...
    <div runat="server" id="divContents">
        ...
        <br />
       <table style="width:100%;" runat="server" id="tblWindHail">
            <tr>
                <td style="text-align:right;width:50%;">
