<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctl_BOP_ENDO_Coverages.ascx.vb" Inherits="IFM.VR.Web.ctl_BOP_ENDO_Coverages" %>
                ...
                <td>
                    <table>
                        <tr>
                            ...
                            <td class="DataColumn">
                                <asp:DropDownList ID="ddlContractorsPropertyLimitAtEachCoveredJobsite" runat="server" CssClass="MediumControl">
                                    ...
                                    <asp:ListItem Value="49">20,000</asp:ListItem>
                ...
                <td>
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="DataColumn">
                                <asp:DropDownList ID="ddlCrimeTotalLimit" runat="server" CssClass="MediumControl">
                                    <asp:ListItem></asp:ListItem>
                                    <%--<asp:ListItem Value="15">5,000</asp:ListItem>
                                    <asp:ListItem Value="7">10,000</asp:ListItem>--%>
                                    <asp:ListItem Value="8">25,000</asp:ListItem>
