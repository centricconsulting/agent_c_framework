<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctl_InlandMarineAssignedAI.ascx.vb" Inherits="IFM.VR.Web.ctl_InlandMarineAssignedAI" %>
            ...
            <td>
                <table style="width: 100%">
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlIMType" runat="server" CssClass="BldDDL" />
                        </td>
                    </tr>
