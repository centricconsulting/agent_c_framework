<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctl_BOP_ENDO_App_Building.ascx.vb" Inherits="IFM.VR.Web.ctl_BOP_ENDO_App_Building" %>
...
<div id="MainDiv" runat="server">
    ...
    <div>
        ...
        <%--6/8/2017 - added table from ctl_BOP_ENDO_App_Location--%>
        <table>
            <tr id="trPrefillInfoTextEndoOldCo" runat="server" style="display:none;" class="informationalText">
                <td colspan="4">The Year Built and Square Feet might be pre-populated with data from our database service. If prefilled data is modified, please be aware changes are subject to review by your underwriter.</td>
            </tr>
            <tr id="trPrefillInfoTextEndoNewCo" runat="server" style="display:none;" class="informationalText">
                <td colspan="4">The Year Built, Square Feet and Number of Stories might be pre-populated with data from our database service. If prefilled data is modified, please be aware changes are subject to review by your underwriter.</td>
            </tr>
                ...
                <td colspan="4">
                    <table style="width:100%;">
                        <tr>
                            ...
                            <td><asp:TextBox ID="txtNumOfStoriesNewCo" runat="server" onkeypress='return event.charCode >= 48 && event.charCode <= 57' Width="40px" MaxLength="3"></asp:TextBox></td>
                        </tr>
                    </table>
                </td>
            </tr>
            <tr id="trOldCo" runat="server">
                <td class="BLDLabelColumn">*Square Feet
                </td>
                ...
                <td class="BLDLabelColumn">*Year Built
                </td>
                <td class="BLDDataColumn">
            ...
            <tr>
                <td class="BLDLabelColumn">*Year Roof Updated
                </td>
                <td class="BLDDataColumn">
                ...
                <td class="BLDLabelColumn">*Year Wiring Updated
                </td>
                <td class="BLDDataColumn">
            ...
            <tr>
                <td class="BLDLabelColumn">*Year Plumbing Updated
                </td>
                <td class="BLDDataColumn">
                ...
                <td class="BLDLabelColumn">*Year Heat Updated
                </td>
                <td class="BLDDataColumn">
        ...
        <%--<table style="width: 100%;">
            ...
            <tr>
                <td>
                    <asp:Label ID="lblGenericAI" runat="server" Text="Generic AI" Font-Bold="true"></asp:Label>
                    <br />
                    <table style="width: 100%">
                        <tr>
                            <td class="BLDAILabelColumn">&nbsp;&nbsp;
                            ...
                            <td>
                                <asp:DropDownList ID="ddlGAIDescriptioner" runat="server" CssClass="BldDDL">
                                    <asp:ListItem Value="0">N/A</asp:ListItem>
                                    <asp:ListItem Value="1">Building</asp:ListItem>
                                    <asp:ListItem Value="2">Personal Property</asp:ListItem>
                                    <asp:ListItem Value="3">Drill</asp:ListItem>
                                    <asp:ListItem Value="4">Hammer</asp:ListItem>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlGAILimitLossPayeeName" runat="server" CssClass="BldDDL">
                                    <asp:ListItem Value="0">N/A</asp:ListItem>
                                    <asp:ListItem Value="1">Test AI</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
