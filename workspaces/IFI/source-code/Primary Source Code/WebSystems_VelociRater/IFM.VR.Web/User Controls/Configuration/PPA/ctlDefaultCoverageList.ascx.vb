...
Public Class ctlDefaultCoverageList
    ...
    Public Sub GetDefaults_Populate(ageRange As Integer, vehicleAge As Integer, vehicleRatio As Integer)
        Dim userDefaultCoverages As List(Of DefaultCoverage.DefaultCoverageGrid) = DefaultCoverage.DefaultCoverage.GetDefaultValues(ageRange + 1, vehicleAge + 1, vehicleRatio + 1, Session("DiamondUsername").ToString)
        Me.DataList1.DataSource = userDefaultCoverages
    ...
    Public Function Save() As Boolean Implements IVRUI_P.Save
        For Each cntrl As DataList In Me.DataList1.Items
            Dim agentDefaults As ctlDefaultCoverages = cntrl.FindControl("ctlDefaultCoverages")
    ...
    Private Sub DataList1_ItemDataBound(sender As Object, e As DataListItemEventArgs) Handles DataList1.ItemDataBound
        Dim defaultCoverages As ctlDefaultCoverages = e.Item.FindControl("ctlDefaultCoverages")
        defaultCoverages.DefaultCoverage_Populate(DataList1.DataSource, rowCount)
    End Sub
End Class