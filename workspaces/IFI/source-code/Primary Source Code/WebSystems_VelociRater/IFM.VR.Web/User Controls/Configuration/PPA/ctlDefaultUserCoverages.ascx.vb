...
Public Class ctlDefaultUserCoverages
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            LoadStaticData()
            ddAgeRange.SelectedIndex = 0
            rdoOver7.SelectedIndex = 1
            rdoVehDrvr.SelectedIndex = 0
            ctlDefaultCoverageList.GetDefaults_Populate(ddAgeRange.SelectedIndex, rdoOver7.SelectedIndex, rdoVehDrvr.SelectedIndex)
        End If

    End Sub

    Public Sub LoadStaticData() Implements IVRUI_P.LoadStaticData
        'Load Age Range Dropdown
        ddAgeRange.Items.Add("16-23")
        ddAgeRange.Items.Add("24-40")
        ddAgeRange.Items.Add("40-65")
        ddAgeRange.Items.Add("66+")

        'Load Vehicle Age Radio Buttons
        rdoOver7.Items.Add("Yes")
        rdoOver7.Items.Add("No")

        'Load Vehicle / Driver Ratio Radio Buttons
        rdoVehDrvr.Items.Add("Yes")
        rdoVehDrvr.Items.Add("No")
    End Sub
    ...
    Protected Sub ddAgeRange_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddAgeRange.SelectedIndexChanged
        Populate()
    End Sub

    Protected Sub rdoVehDrvr_SelectedIndexChanged(sender As Object, e As EventArgs) Handles rdoVehDrvr.SelectedIndexChanged
        Populate()
    End Sub

    Protected Sub rdoOver7_SelectedIndexChanged(sender As Object, e As EventArgs) Handles rdoOver7.SelectedIndexChanged
        Populate()
    End Sub
End Class