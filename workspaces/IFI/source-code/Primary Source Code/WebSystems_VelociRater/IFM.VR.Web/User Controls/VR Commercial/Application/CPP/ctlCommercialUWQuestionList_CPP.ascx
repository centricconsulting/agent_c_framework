<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctlCommercialUWQuestionList_CPP.ascx.vb" Inherits="IFM.VR.Web.ctlCommercialUWQuestionList_CPP" %>
<%@ Register Src="~/User Controls/VR Commercial/Application/CPP/ctlCommercialUWQuestionItem_CPP.ascx" TagPrefix="uc1" TagName="ctlCommercialUWQuestionItem_CPP" %>
...
<script type="text/javascript">
    ...
    function AllOpenTextboxesHaveValues() {
        ...
        $('.questionTable').each(function () {
            ...
            if (($(this).find('input').eq(1).is(':checked') || addInfo.hasClass("alwaysShow")) && !addInfo.hasClass("neverShow") && !addInfo.hasClass("NotRequired")) {
                if (textArea.val() == '') {
    ...
    function AllQuestionsAreAnswered() {
        ...
        $('.questionTable.required').each(function () {
            ...
            if ($($(this).find('input')[0]).is(':checked') || $($(this).find('input')[1]).is(':checked')) {
                ...
                // Testing - set this to auto select required items.
    ...
    // LOB = "CPP" question handling for special cases/events.
    function HandleRadioButtonClicksCPP(diamondcode, selection) {
        // Handle specific code by diamondcode
        if (selection == 'rbYes') {
            // Process if yes is selected
            switch (diamondcode) {
    ...
    // LOB = "CPP" question handling for special cases/events.
    function HandleTextareaChangeCPP(diamondcode) {
        switch (diamondcode) {
            case 9400:
                var copyToDiamondCode = 9010;
                // check; if text area empty then default 9255 to 9002 -- Update 01/11/2018 Force the change and disable 9255
    ...
    function toggleButtons(lob) {
        // Set Tables
        $(".UWQuestionsLOBSection").each(function () {
            if ($(this).hasClass(lob)) {
    ...
    $(function () {
        ...
        //Default Crime Code to Yes
        selectRadioButton('9386', 'rbYes')
        ...
        $('.questionTable input:radio').on('click', function () {
            ...
            switch (ctlCommercialUWQuestionList_LOB) {
                ...
                case "CPR":
                    ...
                    break;
                case "CPP":
                    HandleRadioButtonClicksCPP(code, selection);
                    break;
                default:
                    break;
            }
    ...
    <table id="tblMain" runat="server" style="border-collapse: collapse; width: 100%; display: table;">
        <tr>
            <td valign="top">
                ...
                <%--Commercial Property--%>
                <section id="CPR_Section" class="UWQuestionsLOBSection CPR" style="margin: auto 30px;" runat="server">
                    <h3>
                        <asp:Label ID="Label0" runat="server" Text="Section">Commercial Property</asp:Label>
                    </h3>
                    <div style="border-collapse: collapse; width: 100%; display: table;">
                        <%--Add each section's questions--%>
                        <asp:Repeater ID="rptCPR" runat="server">
                            <ItemTemplate>
                                <section class="UWQuestionsSection" style="margin: auto 30px;">
                                    ...
                                    <div style="border-collapse: collapse; width: 100%; display: table;">
                                        <%--Add each section's questions--%>
                                        <uc1:ctlCommercialUWQuestionItem_CPP runat="server" ID="ctlCommercialUWQuestionItem_CPP" />
                                    </div>
                                </section>
                            </ItemTemplate>
                        </asp:Repeater>
                        <%--Buttons--%>
                        <asp:Button ID="CGLButton" runat="server" Text="Continue to GL Questions" CssClass="StandardSaveButton" OnClientClick="return toCGL()" />
                    </div>
                </section>

                <%--Cmmercial General Liability--%>
                <section id="CGL_Section" class="UWQuestionsLOBSection CGL" style="margin: auto 30px;" runat="server">
                    <h3>
                        <asp:Label ID="Label1" runat="server" Text="Section">Commercial General Liability</asp:Label>
                    </h3>
                    <div style="border-collapse: collapse; width: 100%; display: table;">
                        <%--Add each section's questions--%>
                        <asp:Repeater ID="rptCGL" runat="server">
                            <ItemTemplate>
                                <section class="UWQuestionsSection" style="margin: auto 30px;">
                                    <h3>
                                        <asp:Label ID="lblAccordHeader" runat="server" Text="Section"></asp:Label>
                        ...
                        <%--Buttons--%>
                        <asp:Button ID="CIMButton" runat="server" Text="Continue to IM Questions" CssClass="StandardSaveButton" OnClientClick="return toCIM()" />
                        <asp:Button ID="CRMButton" runat="server" Text="Continue to Crime Questions" CssClass="StandardSaveButton" OnClientClick="return toCRM()" />
                    </div>
                </section>

                <%--Inland Marine--%>
                <section id="CIM_Section" class="UWQuestionsLOBSection CIM" style="margin: auto 30px;" runat="server" visible="false">
                    <h3>
                        <asp:Label ID="Label2" runat="server" Text="Section">Inland Marine</asp:Label>
                    </h3>
                    <div style="border-collapse: collapse; width: 100%; display: table;">
                        <%--Add each section's questions--%>
                        <asp:Repeater ID="rptCIM" runat="server">
                            <ItemTemplate>
                                <section class="UWQuestionsSection" style="margin: auto 30px;">
                                    <h3>
                                        <asp:Label ID="lblAccordHeader" runat="server" Text="Section"></asp:Label>
                        ...
                        <%--Buttons--%>
                        <asp:Button ID="CRMButton2" runat="server" Text="Continue to Crime Questions" CssClass="StandardSaveButton" OnClientClick="return toCRM()" />

                    </div>
                </section>

                <%--Crime--%>
                <section id="CRM_Section" class="UWQuestionsLOBSection CRM" style="margin: auto 30px;" runat="server" visible="false">
                    <h3>
                        <asp:Label ID="Label3" runat="server" Text="Section">Crime</asp:Label>
                    </h3>
                    <div style="border-collapse: collapse; width: 100%; display: table;">
                        <%--Add each section's questions--%>
