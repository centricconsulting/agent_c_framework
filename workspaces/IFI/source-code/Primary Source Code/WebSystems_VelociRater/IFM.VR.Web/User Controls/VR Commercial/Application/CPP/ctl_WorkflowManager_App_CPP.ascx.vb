...
Public Class ctl_WorkflowManager_App_CPP
    ...
    Public Overrides Sub HandleStartUpWorkFlowSelection(workflow As Workflow.WorkflowSection)
        ...
        Select Case workflow
            Case Common.Workflow.Workflow.WorkflowSection.na
                ' Temporary redirect to develop app page MGB 4-11-18
                'SetCurrentWorkFlow(Common.Workflow.Workflow.WorkflowSection.app, "")
            ...
            Case Common.Workflow.Workflow.WorkflowSection.documentPrinting
                ...
                Exit Select
            Case Common.Workflow.Workflow.WorkflowSection.printFriendly 'Updated 12/20/2021 for CPP Endorsements Task 67649 MLW, changed from drivers to printFriendly
    ...
    Public Overrides Sub SetCurrentWorkFlow(workflow As Workflow.WorkflowSection, subWorkFlowIndex As String)
        ...
        Select Case workflow
            Case Common.Workflow.Workflow.WorkflowSection.app
                Me.ctl_AppSection_CPP.Populate()
                Me.ctl_AppSection_CPP.Visible = True
            ...
            Case IFM.VR.Common.Workflow.Workflow.WorkflowSection.uwQuestions
                Me.ctlCommercialUWQuestionList_CPP.Visible = True
                Exit Select
            Case IFM.VR.Common.Workflow.Workflow.WorkflowSection.fileUpload
    ...
    Public Overrides Function Save() As Boolean
        ...
        If _NeedsToRepopulateLocationList = True Then 'added 9/22/2017
            ...
            Me.ctl_AppSection_CPP.PopulateLocationList()
            Me.ctl_AppSection_CPP.PopulateIMList()
        End If
        Return True
    End Function

    Private Sub ctl_AppSection_CPP_AIChanged() Handles ctl_AppSection_CPP.AIChanged 'added 9/22/2017
...
#Region "Save Requests"
    Private Sub ctl_AppSection_CPP_SaveRequested(args As VrControlBaseSaveEventArgs) Handles ctl_AppSection_CPP.SaveRequested
        Me.ControlsToValidate_Custom.Add(Me.ctl_AppSection_CPP)
    End Sub

    Private Sub ctl_AppSection_CAP_App_Rate_ApplicationRatedSuccessfully() Handles ctl_AppSection_CPP.App_Rate_ApplicationRatedSuccessfully
    ...
    Private Sub ctl_AppSection_CAP_QuoteRated() Handles ctl_AppSection_CPP.QuoteRated
        ctlTreeView.RefreshRatedQuote()
    End Sub
