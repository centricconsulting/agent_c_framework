<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctl_CPP_InlandMarine.ascx.vb" Inherits="IFM.VR.Web.ctl_CPP_InlandMarine" %>
...
<%@ Register Src="~/User Controls/Endorsements/Application/CPP/ctl_InlandMarineAssignedAIList.ascx" TagPrefix="uc1" TagName="ctl_IM_AssignedAIList" %>
...
<div id="InlandMarineDiv" class="InlandMarineDiv">
    ...
    <div>
        ...
        <span class="informationalText">**Not sure which coverage your customer needs? Click <a target="_blank" href="<%=System.Configuration.ConfigurationManager.AppSettings("CPP_Help_MTCOAndTransportHelp")%>"><font style="color:blue;font-weight:700;" >Here</font></a></span>
        </div>
    </div>
</div>
<div>
    ...
    <uc1:ctl_IM_AssignedAIList runat="server" id="ctl_IM_AssignedAIList" />
</div>
...
<div id="divEndorsementButtons" runat="server" class="standardSubSection center" style="width: 100%; text-align: center;" visible="false">
    ...
    <asp:Button ID="btnViewCrime" OnClientClick="DisableFormOnSaveRemoves();" CssClass="StandardSaveButton" runat="server" Text="Crime" />
</div>
