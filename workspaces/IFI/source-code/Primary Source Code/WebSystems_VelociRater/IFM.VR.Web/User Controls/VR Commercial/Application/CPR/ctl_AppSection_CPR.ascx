<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctl_AppSection_CPR.ascx.vb" Inherits="IFM.VR.Web.ctl_AppSection_CPR" %>
...
<asp:HiddenField ID="hdn_master_cpr_app" runat="server" />
