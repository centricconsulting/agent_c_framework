<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctl_BOP_NaicsCodeLookup.ascx.vb" Inherits="IFM.VR.Web.ctl_BOP_NaicsCodeLookup" %>
        ...
        <tr>
            <td>
                <asp:DropDownList ID="ddlFilterBy" runat="server" 
                    ...
                    <asp:ListItem Value="2">NAICS Code Description</asp:ListItem>
                    <asp:ListItem Value="3">NAICS Code Description Contains</asp:ListItem>
                    <asp:ListItem Value="1">NAICS Code</asp:ListItem>
                </asp:DropDownList>
            </td>
            <td>
