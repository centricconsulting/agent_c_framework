<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctlCommercialUWQuestionItem.ascx.vb" Inherits="IFM.VR.Web.ctlCommercialUWQuestionItem" %>
<script>
                            ...
                            <table id="tblUWQ" runat="server" class='<%# "questionTable " + DataBinder.Eval(Container.DataItem, "PolicyUnderwritingCodeId") + " " + IIf(DataBinder.Eval(Container.DataItem, "IsQuestionRequired") = True, "required", "") %>'>
                                <tr>
                                    ...
                                    <td class="TableRightColumn">
                                        <table id="tblRadioButtons" runat="server" data-diamondcode='<%# DataBinder.Eval(Container.DataItem, "PolicyUnderwritingCodeId")%>' data-lob='<%#IFM.VR.Common.Helpers.LOBHelper.GetAbbreviatedLOBPrefix(Me.Quote.LobType)%>'>
                                            <tr>
                                                <td>
