...
Public Class ctl_BOP_Building_Information
...
#Region "Methods and Functions"
    ...
    Public Overrides Sub AddScriptWhenRendered()
        ...
        'Me.VRScript.CreateJSBinding(Me.ddlProgram, ctlPageStartupScript.JsEventType.onchange, "BopBuilding.populateClassifications('{0}','{1}','{2}');".FormatIFM(Me.ddlProgram.ClientID, Me.ddlClassification.ClientID, Me.txtClassCode.ClientID))
        'Me.VRScript.CreateJSBinding(Me.ddlClassification, ctlPageStartupScript.JsEventType.onchange, "BopBuilding.populateClassCode('{0}','{1}');".FormatIFM(Me.ddlClassification.ClientID, Me.txtClassCode.ClientID))
        'Me.VRScript.CreateJSBinding(Me.ddlProgram, ctlPageStartupScript.JsEventType.onchange, "if($('#{0}').val() == 'RS'){{$('#{1}').show();}}else{{$('#{1}').hide();}}".FormatIFM(Me.ddlProgram.ClientID, Me.trAnnualReceiptsRow.ClientID), True)
    ...
    Public Overrides Sub LoadStaticData()
        ...
        If IsQuoteReadOnly() Then
            ddlBuildingValuation.Items.Add(New ListItem("Functional Building Valuation", "3"))
        Else
            ...
            End If
        End If
        LoadPropertyDeductible()
    End Sub

    Public Sub LoadPropertyDeductible()
    ...
    Public Sub PopulatePropertyDeductible()
        If Quote IsNot Nothing AndAlso Common.Helpers.BOP.RemovePropDedBelow1k.IsPropertyDeductibleBelow1kAvailable(Quote) Then
    ...
    Public Sub PopulateNewCoFields()
        ...
        If IsNewCo() Then
            ...
            trNumOfStories.Attributes.Add("style", "display:''")
        ...
        Else
            ...
            trNumOfStories.Attributes.Add("style", "display:'none'")
            Me.tdNumberOfStories.InnerText = "Number of Stories"
