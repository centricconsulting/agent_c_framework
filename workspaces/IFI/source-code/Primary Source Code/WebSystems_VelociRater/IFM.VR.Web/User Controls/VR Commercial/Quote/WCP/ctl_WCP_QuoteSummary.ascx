<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctl_WCP_QuoteSummary.ascx.vb" Inherits="IFM.VR.Web.ctl_WCP_QuoteSummary" %>
...
<div id="divWCPQuoteSummary">
    ...
    <div >
        <table style="width: 100%;">
            <colgroup>
                <col class="qs_basic_info_labels_cell qs_resetWidth" id="colWidthSetter" runat="server"/>
            </colgroup>
            <tr>
            ...
            <tr runat="server" ID="trInSecondInjury">
                <td>Indiana Second Injury Fund Surcharge</td>
                <td>
                    <asp:Label ID="lblIndSecondInjurySurcharge" runat="server" Text="Label"></asp:Label>
                </td>
            </tr>
            <tr runat="server" ID="trIL_WCP_CommissionOperationsFundSurcharge_Top">
                <td>Illinois Commissions Operations Fund Surcharge</td>
                <td>
                    <asp:Label ID="lblIL_WCP_CommissionOperationsFundSurcharge_Top" runat="server" Text="Label"></asp:Label>
                </td>
            </tr>
            <tr>
        ...
        <div class="qs_Main_Sections">
            ...
            <div class="qs_Sub_Sections">
                <table class="qa_table_shades">
                    ...
                    <tr class="qs_basic_info_labels_cell  qs_grid_3_columns" runat="server" visible="true" id="wcp_Catastrophe_Terror_Row">
                        <td>Catastrophe (other than Certified Acts of Terrorism)</td>
                        <td></td>
                        <td class="qs_rightJustify" runat="server" id="wcp_Catastrophe_Terror">$200</td>
                    </tr>
                    ...
                    <tr class="qs_basic_info_labels_cell  qs_grid_3_columns" runat="server" visible="true" id="IL_WCP_CommissionOperationsFundSurcharge_Row">
                        <td>Illinois Commissions Operations Fund Surcharge</td>
                        <td></td>
                        <td class="qs_rightJustify" runat="server" id="IL_WCP_CommissionOperationsFundSurcharge_Column">
                            <asp:Label ID="IL_WCP_CommissionOperationsFundSurcharge_Premium" runat="server"></asp:Label>
                        </td>
                    </tr>        
