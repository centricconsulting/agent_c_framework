<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctl_App_AdditionalInsureds_CGL.ascx.vb" Inherits="IFM.VR.Web.ctl_App_AdditionalInsureds_CGL" %>
...
<%--                                    <asp:ListItem Value="0">Select</asp:ListItem>
                                    ...
                                    <asp:ListItem Value="926">Controlling Interests</asp:ListItem>
