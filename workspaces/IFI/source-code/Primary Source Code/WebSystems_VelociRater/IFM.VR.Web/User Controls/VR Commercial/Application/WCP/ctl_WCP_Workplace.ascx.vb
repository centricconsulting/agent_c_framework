...
Public Class ctl_WCP_Workplace
...
#Region "Declarations"
    ...
    Public Property WorkplaceIndex As Int32
        Get
            Return ViewState.GetInt32("vs_WCPWorkplaceIndex", -1)
        End Get
        Set(value As Int32)
            ViewState("vs_WCPWorkplaceIndex") = value
        End Set
    End Property
    ...
    Public ReadOnly Property IsFirstLocationForStatePart As Boolean
        Get
            Return IFM.VR.Common.Helpers.MultiState.Locations.IsFirstLocationForAnySubQuote(Me.Quote, Me.MyWorkplace)
        End Get
    End Property
...
#Region "Methods and Functions"
    ...
    Private Sub UpdateAccordHeader()
        If MyWorkplace IsNot Nothing AndAlso MyWorkplace.Address IsNot Nothing Then
            ...
            If MyWorkplace.Address.DisplayAddress.Trim.Length <= 24 Then
            ...
            End If
            lblAccordHeader.Text = "Workplace # " & WorkplaceIndex + 1.ToString & " " & dsc
        Else
            lblAccordHeader.Text = "Workplace # " & WorkplaceIndex + 1.ToString
        End If
    End Sub
    ...
    Public Overrides Sub Populate()
        ...
        Try
            ...
            If IsFirstLocationForStatePart Then
                ...
                Me.lnkClear.Visible = False
            Else
                Me.lnkDelete.Visible = True
                Me.lnkClear.Visible = True
            End If

            Me.ddState.Enabled = Not Me.IsFirstLocationForStatePart
