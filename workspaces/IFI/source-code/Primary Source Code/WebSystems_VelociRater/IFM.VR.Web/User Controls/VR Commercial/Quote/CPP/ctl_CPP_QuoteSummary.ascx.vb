...
Public Class ctl_CPP_QuoteSummary
...
#End Region
    ...
    Private Sub PopulatePolicyLevelCoverages()
        ...
        If Quote IsNot Nothing AndAlso SubQuoteFirst IsNot Nothing Then
            ...
            ' CLI
            If QQHelper.doUseNewVersionOfLOB(Quote, LOBIFMVersions.CyberLiabilityUpgrade) Then
                If SubQuoteFirst.CyberLiability AndAlso SubQuoteFirst.CyberLiabilityTypeId = "23" Then
                    ...
                    End If
                    rowCLI.Visible = True
                    tdCLIPremium.InnerText = QQHelper.GetSumForPropertyValues(SubQuotes, Function() Quote.CyberLiabilityPremium)
                End If
            End If
    ...
    Private Sub PopulateLocationInformation()
        ...
        If Quote IsNot Nothing And Quote.Locations IsNot Nothing Then
            For Each LOC As QuickQuote.CommonObjects.QuickQuoteLocation In Quote.Locations
                ...
                ' Don't populate optional location coverages on CPP summary - 4/26/2018 BRD Page 241 Yes add this to CPP App Side - CAH
                'If Quote.LobType <> QuickQuote.CommonObjects.QuickQuoteObject.QuickQuoteLobType.CommercialPackage Then PopulateOptionalLocationCoverages(html, LOC)
    ...
    Private Sub PopulateInlandMarine()
        ...
        'Dim limComputer As String = Format(CDec(QQHelper.GetSumForPropertyValues(SubQuotes, Function() Quote.ComputerBuildingsTotalLimit)), NumFormatWithCents)
    ...
    Private Sub lnkPrint_Click(sender As Object, e As EventArgs) Handles lnkPrint.Click
        Try
            Fire_BroadcastWorkflowChangeRequestEvent(Common.Workflow.Workflow.WorkflowSection.printFriendly, "") 'Updated 12/20/2021 for CPP Endorsements Task 67649 MLW
        Catch ex As Exception
