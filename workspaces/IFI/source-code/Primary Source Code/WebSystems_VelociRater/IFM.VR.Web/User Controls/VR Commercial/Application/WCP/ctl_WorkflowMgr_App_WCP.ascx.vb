...
Partial Class ctl_WorkflowMgr_App_WCP
    ...
    Public Overrides Sub ValidateControl(valArgs As VRValidationArgs)
        ...
        If validateEffectiveDate Then ' you check this because you only want to validate if it is coming from the btnFinalRate_Click() below - all other times you do no validate the effective date because it isn't even on the screen
            ...
            Dim valList2 = IFM.VR.Validation.ObjectValidation.CommLines.LOB.WC.PolicyLevelValidations.ValidatePolicyLevel(Me.Quote, valArgs.ValidationType)
...
#Region "Workflows"
    ...
    Public Sub HideAllControls()
        For Each cntrl As VRControlBase In Me.ChildVrControls
            cntrl.Visible = False
        Next
        Me.ctl_ReturnToQuoteSide.Visible = True
    End Sub
    ...
    Public Overrides Sub SetCurrentWorkFlow(workflow As IFM.VR.Common.Workflow.Workflow.WorkflowSection, subWorkFlowIndex As String)
        ...
        Select Case workflow
            Case IFM.VR.Common.Workflow.Workflow.WorkflowSection.app
                Me.ctl_AppSection_WCP.Visible = True
    ...
    Private Sub ctl_WorkflowManager_App_WCP_BroadcastWorkflowChangeRequestEvent(type As Workflow.WorkflowSection, subworkflowParm As String) Handles Me.BroadcastWorkflowChangeRequestEvent
        Select Case type
...
#Region "Save Requests"
    ...
    'Private Sub ctl_AppSection_WCP_App_Rate_ApplicationRatedSuccessfully() Handles ctl_AppSection_WCP.App_Rate_ApplicationRatedSuccessfully
...
#Region "Tree Events"
                ...
                Else
                    ...
                    Select Case Quote.LobType
                        Case QuickQuote.CommonObjects.QuickQuoteObject.QuickQuoteLobType.WorkersCompensation
                            If Quote.PolicyUnderwritings IsNot Nothing AndAlso Quote.PolicyUnderwritings.Count > 6 Then ' WCP has 6 kill questions...
    ...
    Private Sub ctl_AppSection_WCP_SaveRequested(args As VrControlBaseSaveEventArgs) Handles ctl_AppSection_WCP.SaveRequested
        ...
        Me.ControlsToValidate_Custom.Add(Me.ctl_AppSection_WCP)
    End Sub
