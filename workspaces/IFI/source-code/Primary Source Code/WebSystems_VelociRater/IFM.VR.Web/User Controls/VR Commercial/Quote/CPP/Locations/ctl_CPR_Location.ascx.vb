...
Public Class ctl_CPR_Location
    ...
    Private Sub UpdateHeader()
        Dim txt As String = String.Format("Location #" & MyLocationIndex + 1.ToString & " - {0} {1} {2}", Me.MyLocation.Address.HouseNum, Me.MyLocation.Address.StreetName, Me.MyLocation.Address.City)
        Me.lblAccordHeader.Text = txt.Ellipsis(37)
