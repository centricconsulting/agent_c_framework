...
Public Class ctl_CPR_PropertyInOpenList
    ...
    Public Sub HandleAgreedAmountChange(ByVal newvalue As Boolean)
        ...
        For Each cntrl As RepeaterItem In Me.Repeater1.Items
            Dim PIOControl As ctl_CPR_PropertyInOpenItem = cntrl.FindControl("ctl_CPR_PropInOpenItem")
    ...
    Private Sub lnkBtnAdd_Click(sender As Object, e As EventArgs) Handles lnkAdd.Click
        ...
        Else
            ...
            cls.DeductibleId = "9"      ' Was 500, changed to 1000 per task 62836
        End If
    ...
    Public Sub PopulatePropInOpen()
        For Each ri As RepeaterItem In Repeater1.Items
            Dim ctl As ctl_CPR_PropertyInOpenItem = ri.FindControl("ctl_CPR_PropInOpenItem")
            If ctl IsNot Nothing Then
                ctl.LoadPIODeductible()
                ctl.PopulatePIODeductible()
            End If
        Next
    End Sub
End Class