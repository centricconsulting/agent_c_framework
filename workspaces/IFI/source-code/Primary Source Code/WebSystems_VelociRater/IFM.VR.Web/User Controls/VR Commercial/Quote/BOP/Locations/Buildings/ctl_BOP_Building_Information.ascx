<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctl_BOP_Building_Information.ascx.vb" Inherits="IFM.VR.Web.ctl_BOP_Building_Information" %>
...
<%--                            <asp:ListItem Value="16">Non-Owner Occupied Bldg / Lessor's</asp:ListItem>
            ...
            <tr id="trNumOfStories" runat="server">
                <td id="tdNumberOfStories" class="LabelColumn">
                    Number of Stories
                </td>
                <td class="DataColumn">
