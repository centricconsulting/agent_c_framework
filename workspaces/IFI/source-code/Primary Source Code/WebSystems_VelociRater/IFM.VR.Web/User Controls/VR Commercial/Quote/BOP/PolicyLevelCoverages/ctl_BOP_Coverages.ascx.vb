...
Public Class ctl_BOP_Coverages
...
#Region "Methods and Functions"
    ...
    Public Overrides Sub LoadStaticData()
        ...
        QQHelper.LoadStaticDataOptionsDropDown(ddlContractorsPropertyLimitAtEachCoveredJobsite, QuickQuoteHelperClass.QuickQuoteClassName.QuickQuoteObject, QuickQuoteHelperClass.QuickQuotePropertyName.ContractorsEquipmentInstallationLimitId, QuickQuoteStaticDataOption.SortBy.None, Me.Quote.LobType)
        QQHelper.LoadStaticDataOptionsDropDown(ddlCrimeTotalLimit, QuickQuoteHelperClass.QuickQuoteClassName.QuickQuoteObject, QuickQuoteHelperClass.QuickQuotePropertyName.CrimeEmpDisLimitId, QuickQuoteStaticDataOption.SortBy.None, Me.Quote.LobType)
    ...
    Public Overrides Sub Populate()
        ...
        Try
            If Me.Quote IsNot Nothing Then
                ...
                If Me.SubQuoteFirst IsNot Nothing Then
                    ...
                    Me.SubQuoteFirst.ContractorsToolsEquipmentBlanket.IsNullEmptyorWhitespace = False Then
                        ...
                        If IsQuoteReadOnly() Then
                            IFM.VR.Web.Helpers.WebHelper_Personal.SetDropDownValue_ForceDiamondValue(ddlContractorsPropertyLimitAtEachCoveredJobsite, Me.SubQuoteFirst.ContractorsEquipmentInstallationLimitId, QuickQuote.CommonMethods.QuickQuoteHelperClass.QuickQuoteClassName.QuickQuoteObject, QuickQuote.CommonMethods.QuickQuoteHelperClass.QuickQuotePropertyName.ContractorsEquipmentInstallationLimitId)
                        Else
                            Me.ddlContractorsPropertyLimitAtEachCoveredJobsite.SetFromValue(Me.SubQuoteFirst.ContractorsEquipmentInstallationLimitId)
                        End If
                    ...
                    If Me.SubQuoteFirst.CrimeEmpDisEmployeeText.IsNullEmptyorWhitespace = False Then
                        ...
                        If IsQuoteReadOnly() Then
                            IFM.VR.Web.Helpers.WebHelper_Personal.SetDropDownValue_ForceDiamondValue(ddlCrimeTotalLimit, Me.SubQuoteFirst.CrimeEmpDisLimitId, QuickQuote.CommonMethods.QuickQuoteHelperClass.QuickQuoteClassName.QuickQuoteObject, QuickQuote.CommonMethods.QuickQuoteHelperClass.QuickQuotePropertyName.CrimeEmpDisLimitId)
                            ddlCrimeTotalLimit.Width = "100" 'Added 10/13/2021 for BOP Endorsements Task 65791 MLW
                        Else
                            ddlCrimeTotalLimit.SetFromValue(Me.SubQuoteFirst.CrimeEmpDisLimitId)
                        End If
                ...
                If IsQuoteReadOnly() Then
                    btnSavePolicyLevelCoverages.Visible = False
                    ...
                    trOwnersLesseesContractorsAutomaticInfoRow.Visible = False
                    trWaiverOfSubroInfoRow.Visible = False
                    trOwnersLesseesContractorsCompletedOpsInfoRow.Visible = False
                    trCyberLiabilityInfoRow.Visible = False
                    trEmployeeBenefitsLinkAndInfoRow.Visible = False
                    trEmploymentPracticesInfoRow.Visible = False
                    trContractorsInfoRow.Visible = False
                    trCrimeInfoRow.Visible = False
                    trNonOwnedInfoRow.Visible = False
                    trElectronicDataInfoRow.Visible = False
                    ...
                    Me.SubQuoteFirst.ContractorsToolsEquipmentScheduled.IsNullEmptyorWhitespace = False Or
                    Me.SubQuoteFirst.ContractorsToolsEquipmentBlanket.IsNullEmptyorWhitespace = False Then
                        ctl_ContractorsEQList.Visible = True
                        ctl_ContractorsEQList.Populate()
                    Else
                        ctl_ContractorsEQList.Visible = False
                    End If
                Else
                    btnMakeAChange.Visible = False
                    ctl_ContractorsEQList.Visible = False
                    trContractorsEquipmentScheduled.Visible = False
                End If
            End If
            Exit Sub
        Catch ex As Exception
