<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctl_CPR_App_Building.ascx.vb" Inherits="IFM.VR.Web.ctl_CPR_App_Building" %>
...
<div>
    <style>
        /*re-named from BLDLabelColumn 6/8/2017... so we could use that for the stuff that came over from ctl_CPR_App_Location*/
        .BLDAILabelColumn {
            width:30%;
            text-align:right;
        }
        ...
        /*added 6/8/2017; originally came from ctl_CPR_App_Location and then re-named*/
        .BLDLabelColumn {
            width:32%;
            text-align:left;
        }
    ...
    <%--6/8/2017 - added table from ctl_CPR_App_Location--%>
    <table>
    ...
    <br />
    <table style="width:100%;">
        <asp:Panel id="pnlBuildingLimit" runat="server" Visible="false">
        <tr>
            <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlBuildingLimitLossPayeeType" runat="server" CssClass="BldDDL">
                                ...
                                <%--<asp:ListItem Value="78">Loss Payable - Building Owner</asp:ListItem>--%><%-- removed for CPR & CPP - only applies to BOP --%>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
        ...
        <asp:Panel id="pnlPersonalPropertyLimit" runat="server" Visible="false">
        <tr>
            <td>
        ...
        <asp:Panel id="pnlPersonalPropertyLimitOthers" runat="server" Visible="false">
        <tr>
            <td>
                <asp:Label ID="lblPersonalPropertyLimitOthers" runat="server" Text="Personal Property Limit Of Others: $xx,xxx,xxx" Font-Bold="true"></asp:Label>
                <br />
                <table style="width:100%">
                    <tr>
                        <td class="BLDAILabelColumn">
                        ...
                        <td>
                            <asp:DropDownList ID="ddlPersonalPropertyLimitOthersLossPayeeName" runat="server" CssClass="BldDDL"></asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td class="BLDAILabelColumn">
                        ...
                        <td>
                            <asp:DropDownList ID="ddlPersonalPropertyLimitOthersLossPayeeType" runat="server" CssClass="BldDDL">
                                <asp:ListItem Value="65">Loss Payable</asp:ListItem>
                                <asp:ListItem Value="66">Lenders Loss Payable</asp:ListItem>
                                <asp:ListItem Value="67">Contract of Sale</asp:ListItem>
                            </asp:DropDownList>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlPersonalPropertyLimitOthersATIMA" runat="server" CssClass="BldDDL">
                                <asp:ListItem Value="0">None</asp:ListItem>
                                <asp:ListItem Value="1">ATIMA</asp:ListItem>
                                <asp:ListItem Value="2">ISAOA</asp:ListItem>
                                <asp:ListItem Value="3">ATIMA/ISAOA</asp:ListItem>
        ...
        <asp:Panel id="pnlBusinessIncomeLimit" runat="server" Visible="false">
        <tr>
            <td>
                <asp:Label ID="lblBusinessIncomeLimit" runat="server" Text="Business Income Limit: $xx,xxx,xxx" Font-Bold="true"></asp:Label>
                <br />
                <table style="width:100%">
                    <tr>
                        <td class="BLDAILabelColumn">
                        ...
                        <td>
                            <asp:DropDownList ID="ddlBusinessIncomeLimitLossPayeeName" runat="server" CssClass="BldDDL"></asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td class="BLDAILabelColumn">
                        ...
                        <td>
                            <asp:DropDownList ID="ddlBusinessIncomeLimitLossPayeeType" runat="server" CssClass="BldDDL">
                                <asp:ListItem Value="65">Loss Payable</asp:ListItem>
                                <asp:ListItem Value="66">Lenders Loss Payable</asp:ListItem>
                                <asp:ListItem Value="67">Contract of Sale</asp:ListItem>
                            </asp:DropDownList>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlBusinessIncomeLimitATIMA" runat="server" CssClass="BldDDL">
                                <asp:ListItem Value="0">None</asp:ListItem>
                                <asp:ListItem Value="1">ATIMA</asp:ListItem>
                                <asp:ListItem Value="2">ISAOA</asp:ListItem>
                                <asp:ListItem Value="3">ATIMA/ISAOA</asp:ListItem>
