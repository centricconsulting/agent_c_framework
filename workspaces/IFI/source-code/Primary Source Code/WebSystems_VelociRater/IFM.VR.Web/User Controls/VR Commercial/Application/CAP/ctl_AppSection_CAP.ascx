<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctl_AppSection_CAP.ascx.vb" Inherits="IFM.VR.Web.ctl_AppSection_CAP" %>
...
<%@ Register Src="~/User Controls/VR Commercial/Application/CAP/ctl_CAP_DriverList.ascx" TagPrefix="uc1" TagName="ctl_DriverList" %>
<%@ Register Src="~/User Controls/VR Commercial/Application/CAP/ctl_CAP_App_Vehiclelist.ascx" TagPrefix="uc1" TagName="ctl_VehicleList" %>
<%@ Register Src="~/User Controls/VR Commercial/Application/CAP/ctl_CAP_Symbols.ascx" TagPrefix="uc1" TagName="ctl_Symbols" %>
...
<div id="div_master_bop_app" runat="server">
    ...
    <div>
        ...
        <uc1:ctl_VehicleList runat="server" ID="ctl_CAP_VehicleList" />
        <uc1:ctl_DriverList runat="server" ID="ctl_DriverList1" />
        <uc1:ctl_Symbols runat="server" ID="ctl_CAP_Symbols" />
