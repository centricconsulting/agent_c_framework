...
Public Class ctl_BOP_QuoteSummary
            ...
            If Quote IsNot Nothing Then
                If SubQuoteFirst IsNot Nothing Then
                    ...
                    If SubQuoteFirst.CrimeEmpDisLimit.Trim <> "" Then
                        ...
                        'Commented out per task WS-621 and WS-1279
        ...
        Try
            ...
            For Each BLD As QuickQuote.CommonObjects.QuickQuoteBuilding In LOC.Buildings
                ...
                If BLD.HasMineSubsidence = True Then
                    ...
                    If LOC.Address.State = "OH" Then
                        maxLimit = "300,000"
                    ElseIf LOC.Address.State = "IN" Then
                        maxLimit = "$500,000"
                    ElseIf LOC.Address.State = "IL" Then
                        maxLimit = "$750,000"
                    End If
                    html.AppendLine("<tr class=""qs_bop_basic_info_labels_cell"">")
        ...
        Try
            ...
            If BLD.HasPhotographyCoverage AndAlso BuildingIsFirstOnStateQuoteWithPLCoverage(LOC.Address.QuickQuoteState, BLD, PLCoverages_Enum.Photography) Then
                ...
                If BLD.HasPhotographyCoverageScheduledCoverages Then
                    ...
                    WriteCell(html, indent & "Schedule of Equipment " & Format(QQHelper.DecimalForString(BLD.PhotographyTotalScheduledLimits), "0"), 3)
    ...
    ' Uncomment this section for Printer-Friendly Quote Summary
    ...
    '                                    Response.AddHeader("content-disposition", "attachment; filename=" + String.Format("SUMMARY{0}.pdf", Me.Quote.QuoteNumber))
