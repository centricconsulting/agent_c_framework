<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctl_App_CTEQ.ascx.vb" Inherits="IFM.VR.Web.ctl_App_CTEQ" %>
<h3>
...
<%--                        <td class="ContEqColumn">*Valuation Method</td>--%>
                        <td colspan="2" class="ContEqColumn">*Limit</td>
                    </tr>
                    <tr>
<%--                        <td class="ContEqColumn">
                    ...
                    <tr id="trLossPayeeName" runat="server" style="align-content:center;">
                    ...
                    <tr id="trLossPayeeType" runat="server" style="align-content:center;">
                    ...
                    <tr id="trATIMA" runat="server" style="align-content:center;">
