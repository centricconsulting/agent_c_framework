<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctl_App_CTEQList.ascx.vb" Inherits="IFM.VR.Web.ctl_App_CTEQList" %>
<%@ Register Src="~/User Controls/VR Commercial/Common/ctl_App_CTEQ.ascx" TagPrefix="uc1" TagName="ctlContractorsScheduledItem"  %>
