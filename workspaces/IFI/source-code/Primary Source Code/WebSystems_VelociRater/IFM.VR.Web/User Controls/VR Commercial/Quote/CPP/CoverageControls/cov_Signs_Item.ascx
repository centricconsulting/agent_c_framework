<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="cov_Signs_Item.ascx.vb" Inherits="IFM.VR.Web.cov_Signs_Item" %>
<%@ Register Src="~/User Controls/VR Commercial/Quote/CPP/CoverageControls/cov_Signs_Item_Details.ascx" TagPrefix="uc1" TagName="cov_Signs_Item_Details" %>


<asp:Repeater ID="siRepeater" runat="server">
    <ItemTemplate>
        <div class="ItemGroup">
            ...
            <div style="display: none; margin-bottom: 25px;" class="chkDetail">
                <div runat="server" id="divItemDetails" style="padding-left: 20px; padding-top: 10px;">
                    <table class="qs_grid_4_columns">
                        <uc1:cov_Signs_Item_Details runat="server" id="cov_Signs_Item_Details" />
                    </table>
                </div>
            </div>
        </div>
