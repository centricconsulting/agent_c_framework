<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctl_BOP_GeneralInformation.ascx.vb" Inherits="IFM.VR.Web.ctl_BOP_GeneralInformation" %>
...
<div runat="server" id="divMain">
    ...
    <div id="divBOPGeneralInformation">
        <style type="text/css">
            .LabelColumn {
                text-align:left;
                width:70%;
            ...
            .NarrowControl{width:25%;}
              ...
              <table>
                  ...
                  <tr>
                      ...
                      <td>
                          <asp:DropDownList ID="ddlTenantsFireLiability" runat="server" CssClass="MediumControl"></asp:DropDownList>
                      </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                      <td>
                          ...
                          <label style="margin-left:-3px;" for="<%=chkBusinessMasterEnhancedEndorsement.ClientID%>"><a target="_blank" id="lnkBusinessMaster" runat="server" href="" class="externalLink">BusinessMaster Enhancement Endorsement</a></label>           
                      </td>
                      <td>
