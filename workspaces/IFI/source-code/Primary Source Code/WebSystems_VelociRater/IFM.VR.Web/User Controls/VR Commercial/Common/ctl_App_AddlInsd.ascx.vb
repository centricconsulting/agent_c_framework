...
#Region "Methods and Functions"
    ...
    Public Overrides Sub Populate()
        ...
        Try
            ...
            '    If Quote.PhotographyScheduledCoverages IsNot Nothing AndAlso Quote.PhotographyScheduledCoverages.Count > 0 Then
            '        rptPhotogScheduledItems.DataSource = Quote.PhotographyScheduledCoverages
    ...
    Public Overrides Function Save() As Boolean
        ...
        Try
            ...
            'Quote.PhotographyScheduledCoverages = New List(Of QuickQuote.CommonObjects.QuickQuoteCoverage)
            ...
            '    Quote.PhotographyScheduledCoverages.Add(psc)
            'Next
...
#Region "Events"
    ...
    '            Case "DELETE"
    '                If Quote.PhotographyScheduledCoverages IsNot Nothing AndAlso Quote.PhotographyScheduledCoverages.HasItemAtIndex(ndx) Then
    '                    Quote.PhotographyScheduledCoverages.RemoveAt(ndx)
    '                    Me.Populate()
    '                    Me.Save_FireSaveEvent()
    '                End If
    '                Exit Select
