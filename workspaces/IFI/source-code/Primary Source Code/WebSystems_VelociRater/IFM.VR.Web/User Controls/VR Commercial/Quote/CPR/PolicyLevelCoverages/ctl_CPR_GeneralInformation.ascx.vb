...
Public Class ctl_CPR_GeneralInformation
    ...
    Public Overrides Sub AddScriptWhenRendered()
        ...
        ' Used by the ctl_CPR_Coverages so that the Employee and Liquor Occurrence Limits mirror this one in the General Information
    ...
    Public Overrides Function Save() As Boolean
        ...
        IFM.VR.Common.Helpers.CPR.ClassCodeHelper.ConvertAllClassCodeSubline336ExcludedTo(Me.Quote)
        ...
        If Me.chkGLEnhancement.Checked Then 'only available with the enhancement - Look to Bug 4040 for additional information
            ' String.Empty = 'None'
            ' 1 = 'Yes' CPR1004
            ' 2 = 'YES With Completed Ops' CPR1002
    ...
    Public Overrides Sub ValidateControl(valArgs As VRValidationArgs)
        ...
        Dim vals = IFM.VR.Validation.ObjectValidation.CommLines.LOB.CPR.GeneralInformationValidator.ValidateGeneralInformation(Me.Quote, valArgs.ValidationType)
        If vals.Any() Then
            Dim accordList As List(Of VRAccordionTogglePair) = Me.MyAccordionList ' just to cache it
            For Each v In vals
                Select Case v.FieldId
                    Case IFM.VR.Validation.ObjectValidation.CommLines.LOB.CPR.GeneralInformationValidator.advertisingInjury
                        Me.ValidationHelper.Val_BindValidationItemToControl(Me.ddPersonalInjury, v, accordList)
                    Case IFM.VR.Validation.ObjectValidation.CommLines.LOB.CPR.GeneralInformationValidator.DamageToPremisesRentedLimit
                        Me.ValidationHelper.Val_BindValidationItemToControl(Me.txtRented, v, accordList)
                    Case IFM.VR.Validation.ObjectValidation.CommLines.LOB.CPR.GeneralInformationValidator.deductibleAmount
                        Me.ValidationHelper.Val_BindValidationItemToControl(Me.ddAmount, v, accordList)
                    Case IFM.VR.Validation.ObjectValidation.CommLines.LOB.CPR.GeneralInformationValidator.deductibleBasis
                        Me.ValidationHelper.Val_BindValidationItemToControl(Me.ddBasis, v, accordList)
                    Case IFM.VR.Validation.ObjectValidation.CommLines.LOB.CPR.GeneralInformationValidator.deductibleType
                        Me.ValidationHelper.Val_BindValidationItemToControl(Me.ddType, v, accordList)
                    Case IFM.VR.Validation.ObjectValidation.CommLines.LOB.CPR.GeneralInformationValidator.generalAggregate
                        Me.ValidationHelper.Val_BindValidationItemToControl(Me.ddGeneralAgg, v, accordList)
                    Case IFM.VR.Validation.ObjectValidation.CommLines.LOB.CPR.GeneralInformationValidator.MedicalExpensesLimit
                        Me.ValidationHelper.Val_BindValidationItemToControl(Me.txtMedicalExpense, v, accordList)
                    Case IFM.VR.Validation.ObjectValidation.CommLines.LOB.CPR.GeneralInformationValidator.occurrenceLibLimit
                        Me.ValidationHelper.Val_BindValidationItemToControl(Me.ddOccuranceLibLimit, v, accordList)
                    Case IFM.VR.Validation.ObjectValidation.CommLines.LOB.CPR.GeneralInformationValidator.ProductOperationsAg
                        Me.ValidationHelper.Val_BindValidationItemToControl(Me.ddOperationsAgg, v, accordList)
                    Case IFM.VR.Validation.ObjectValidation.CommLines.LOB.CPR.GeneralInformationValidator.programTypeId
