<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctlIrrigationEquip.ascx.vb" Inherits="IFM.VR.Web.ctlIrrigationEquip" %>
...
<div id="dvIrrigationList" runat="server" class="div">
