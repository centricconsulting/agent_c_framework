<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctlGrainBuilding.ascx.vb" Inherits="IFM.VR.Web.ctlGrainBuilding" %>
...
<div id="dvGrainBuildList" runat="server" class="div">
