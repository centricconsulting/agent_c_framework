<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctlLivestock.ascx.vb" Inherits="IFM.VR.Web.ctlLivestock" %>
...
<div id="dvLivestockList" runat="server" class="div">
