<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctlHomAdditionalInsured.ascx.vb" Inherits="IFM.VR.Web.ctlHomAdditionalInsured" %>
...
<table style="width:100%">
    <tr>
        <td runat="server" id="tdName">
            <asp:Label ID="lblName" runat="server">*Name of Student:</asp:Label>
            <br />
            <asp:TextBox ID="txtName" Width="125" MaxLength="250" runat="server"></asp:TextBox>
        </td>
        <td runat="server" id="tdDescription">
            <asp:Label ID="lblDescription" runat="server">*Name of School:</asp:Label>
            <br />
