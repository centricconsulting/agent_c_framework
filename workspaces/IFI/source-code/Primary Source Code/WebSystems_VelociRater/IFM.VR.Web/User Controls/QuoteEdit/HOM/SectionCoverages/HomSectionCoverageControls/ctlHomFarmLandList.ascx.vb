Public Class ctlHomFarmLandList
    ...
    Public Overrides Sub Populate()
        Me.ctlHomFarmLand.InitFromExisting(Me)
        Me.Repeater1.DataSource = Me.MySubSectionCoverages
        Me.Repeater1.DataBind()
        Me.FindChildVrControls()
        Dim index As Int32 = 1
        For Each c In Me.GatherChildrenOfType(Of ctlHomFarmLand)
            If Not c.Equals(ctlHomFarmLand) Then
