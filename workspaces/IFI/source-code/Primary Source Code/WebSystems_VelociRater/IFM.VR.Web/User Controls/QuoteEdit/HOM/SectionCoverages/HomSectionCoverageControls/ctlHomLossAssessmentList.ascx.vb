Public Class ctlHomLossAssessmentList
    ...
    Public Overrides Sub Populate()
        Me.ctlHomLossAssessment.InitFromExisting(Me)
        Me.Repeater1.DataSource = Me.MySubSectionCoverages
        Me.Repeater1.DataBind()
        Me.FindChildVrControls()
        Dim index As Int32 = 1
        For Each c In Me.GatherChildrenOfType(Of ctlHomLossAssessment)
            If Not c.Equals(ctlHomLossAssessment) Then
