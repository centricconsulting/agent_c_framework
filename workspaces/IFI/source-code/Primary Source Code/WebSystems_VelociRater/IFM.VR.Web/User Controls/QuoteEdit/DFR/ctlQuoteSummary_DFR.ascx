<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctlQuoteSummary_DFR.ascx.vb" Inherits="IFM.VR.Web.ctlQuoteSummary_DFR" %>
...
<div id="divHomeQuoteSummary">
    ...
    <div>
        ...
        <div class="hom_qs_Main_Sections">
            <span class="qs_section_headers">Credits</span>
            <div class="hom_qs_Sub_Sections">
                <table style="width: 100%">
        ...
        <div class="hom_qs_Main_Sections" id="formTypeCoveragesSection" runat="server">
            <span class="qs_section_headers">Form Type Coverages</span>
            <div class="hom_qs_Sub_Sections">
