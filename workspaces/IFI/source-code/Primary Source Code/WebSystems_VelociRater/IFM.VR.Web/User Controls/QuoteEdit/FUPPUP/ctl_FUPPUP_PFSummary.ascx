<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctl_FUPPUP_PFSummary.ascx.vb" Inherits="IFM.VR.Web.ctl_FUPPUP_PFSummary" %>
...
<%@ Register Src="~/Reports/ctlPFFooter.ascx" TagPrefix="uc1" TagName="ctlPFFooter" %>
...
<div id="divUmbrellaQuoteSummary">
    ...
    <center><img src="../images/2017 Black Indiana Farmers Insurance B&W Garfield.jpg" style="height:216px; width:588px"/></center>
    <%--<h3>
    ...
    <uc1:ctlPFFooter runat="server" id="ctlPFFooter" />
</div>