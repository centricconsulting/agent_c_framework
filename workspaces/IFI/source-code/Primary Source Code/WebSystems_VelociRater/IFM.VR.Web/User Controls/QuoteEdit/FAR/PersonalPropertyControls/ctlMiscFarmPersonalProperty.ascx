<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctlMiscFarmPersonalProperty.ascx.vb" Inherits="IFM.VR.Web.ctlMiscFarmPersonalProperty" %>
...
<div id="dvMiscFarmPersPropertyList" runat="server" class="div">
