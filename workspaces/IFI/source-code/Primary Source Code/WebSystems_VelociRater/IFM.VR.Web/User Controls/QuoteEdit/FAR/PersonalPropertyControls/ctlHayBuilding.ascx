<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctlHayBuilding.ascx.vb" Inherits="IFM.VR.Web.ctlHayBuilding" %>
...
<div id="dvHayBuildList" runat="server" class="div">
