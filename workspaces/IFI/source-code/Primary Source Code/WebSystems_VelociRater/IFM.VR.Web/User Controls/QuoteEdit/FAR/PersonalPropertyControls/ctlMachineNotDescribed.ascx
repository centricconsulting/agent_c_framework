<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctlMachineNotDescribed.ascx.vb" Inherits="IFM.VR.Web.ctlMachineNotDescribed" %>
...
<div id="dvMachNotDescList" runat="server" class="div">
