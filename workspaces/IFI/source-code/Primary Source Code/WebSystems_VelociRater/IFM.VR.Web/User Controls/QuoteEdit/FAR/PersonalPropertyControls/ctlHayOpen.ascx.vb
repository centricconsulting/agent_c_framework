...
Public Class ctlHayOpen
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        PersPropType = QuickQuoteScheduledPersonalPropertyCoverage.QuickQuoteScheduledPersonalPropertyCoverageType.Farm_F_Hay_in_the_Open
    End Sub
    ...
    Public Overrides Sub ValidateControl(valArgs As VRValidationArgs)
        ...
        For Each cntrl As RepeaterItem In PersPropRepeater.Items
            Dim increasedLimitControl As ctlFarmScheduledLimit = cntrl.FindControl("ctlFarmScheduledLimit")
            increasedLimitControl.PersPropType = PersPropType
            increasedLimitControl.ValidatorGroupName = "Hay in the Open"
        Next
