...
Public Class ctlReproductiveEquip
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        PersPropType = QuickQuoteScheduledPersonalPropertyCoverage.QuickQuoteScheduledPersonalPropertyCoverageType.ReproductiveMaterials
    End Sub
    ...
    Public Overrides Sub ValidateControl(valArgs As VRValidationArgs)
        ...
        For Each cntrl As RepeaterItem In PersPropRepeater.Items
            Dim increasedLimitControl As ctlFarmScheduledLimit = cntrl.FindControl("ctlFarmScheduledLimit")
            increasedLimitControl.PersPropType = PersPropType
            increasedLimitControl.ValidatorGroupName = "Reproductive Equipment"
        Next
