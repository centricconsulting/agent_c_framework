...
Public Class ctlBorrowed
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        PersPropType = QuickQuoteScheduledPersonalPropertyCoverage.QuickQuoteScheduledPersonalPropertyCoverageType.Farm_Rented_or_borrowed_Equipment
    End Sub
    ...
    Public Overrides Sub ValidateControl(valArgs As VRValidationArgs)
        ...
        For Each cntrl As RepeaterItem In PersPropRepeater.Items
            Dim increasedLimitControl As ctlFarmScheduledLimit = cntrl.FindControl("ctlFarmScheduledLimit")
            increasedLimitControl.PersPropType = PersPropType
            increasedLimitControl.ValidatorGroupName = "Rented or Borrowed Equipment"
        Next
