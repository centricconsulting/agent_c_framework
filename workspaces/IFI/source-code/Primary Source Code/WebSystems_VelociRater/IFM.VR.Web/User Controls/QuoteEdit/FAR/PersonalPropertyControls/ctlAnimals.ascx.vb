...
Public Class ctlAnimals
    ...
    'Private _persPropType As QuickQuote.CommonObjects.QuickQuoteOptionalCoverage.QuickQuoteOptionalCoverageType
    'Public Property PersPropType() As QuickQuote.CommonObjects.QuickQuoteOptionalCoverage.QuickQuoteOptionalCoverageType
    '    Get
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        PersPropType = QuickQuoteOptionalCoverage.QuickQuoteOptionalCoverageType.Farm_4_H_and_FFAAnimals
    End Sub
    ...
    Public Overrides Sub Populate()
        If Quote IsNot Nothing Then
            Try
                ...
                'If SubQuoteFirst IsNot Nothing AndAlso SubQuoteFirst.OptionalCoverages IsNot Nothing Then
                If GoverningStateQuote() IsNot Nothing AndAlso GoverningStateQuote.OptionalCoverages IsNot Nothing Then
                    'PersPropRepeater.DataSource = SubQuoteFirst.OptionalCoverages.FindAll(Function(p) p.CoverageType = PersPropType)
                    PersPropRepeater.DataSource = GoverningStateQuote.OptionalCoverages.FindAll(Function(p) p.CoverageType = PersPropType)
                End If
    ...
    Public Overrides Function Save() As Boolean
        For Each cntrl As RepeaterItem In PersPropRepeater.Items
            ...
            increasedLimitControl.OptPersPropType = PersPropType
        Next
    ...
    Private Sub RemovePersPropItem(rowNumber As Integer)
        RaiseEvent RemoveItem(rowNumber, PersPropType, QuickQuoteScheduledPersonalPropertyCoverage.QuickQuoteScheduledPersonalPropertyCoverageType.None)
    End Sub
    ...
    Public Overrides Sub ValidateControl(valArgs As VRValidationArgs)
        ...
        For Each cntrl As RepeaterItem In PersPropRepeater.Items
            Dim increasedLimitControl As ctlFarmScheduledLimit = cntrl.FindControl("ctlFarmScheduledLimit")
            increasedLimitControl.OptPersPropType = PersPropType
            increasedLimitControl.ValidatorGroupName = "4H and FFA Animals"
        Next
