<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctlGrainOpen.ascx.vb" Inherits="IFM.VR.Web.ctlGrainOpen" %>
...
<div id="dvGrainOpenList" runat="server" class="div">
