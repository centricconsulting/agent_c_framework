<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctl_Summary_CGL.ascx.vb" Inherits="IFM.VR.Web.ctl_Summary_CGL" %>
    ...
    <div>
        ...
        <div class="hom_qs_Main_Sections">
            ...
            <div class="hom_qs_Sub_Sections">
                <asp:Literal ID="tblGeneralInfo" runat="server"></asp:Literal>
            </div>
        </div>

         <div class="hom_qs_Main_Sections">
            <span class="qs_section_headers">Policy Coverage</span>
            <div class="hom_qs_Sub_Sections">
