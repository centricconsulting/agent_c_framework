...
Public Class VR3360ValueReturn
        ...
        If Page.IsPostBack = False Then
            ...
            If Request IsNot Nothing Then
                If Request.QueryString IsNot Nothing Then
                    ...
                    pvHelper.Process360ValueResponseFromNameValueCollectionAndSetVariables(Request.QueryString, quoteId, lobId, locationNum, buildingNum, True, wasSaveSuccessful, errorMsg, policyId:=policyId, policyImageNum:=policyImageNum) 'omitting saveAllReturnValues optional param
            ...
            If errorMsg = "" Then
                errorMsg = "Problem Processing 360Value Response"
            End If
