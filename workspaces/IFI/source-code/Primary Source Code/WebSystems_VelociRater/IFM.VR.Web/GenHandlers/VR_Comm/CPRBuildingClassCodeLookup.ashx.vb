...
Public Class CPRBuildingClassCodeLookup
    ...
    Overrides Sub ProcessRequest(ByVal context As HttpContext)
        ...
        If context.Request.QueryString("query") IsNot Nothing Then
            If context.Request.QueryString("ClassCode") IsNot Nothing AndAlso context.Request.QueryString("SearchText") IsNot Nothing Then
                ...
                ' CF = Property
                ' CR = Crime
                context.Response.Write(GetjSon(IFM.VR.Common.Helpers.CPR.CPRBuildingClassCodeHelper.GetClassCodes(ClassCode, SearchText, "CF", "0")))
            End If
        End If
