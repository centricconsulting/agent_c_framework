Public Class VR3Farm
    ...
    Public Overrides Sub HandleStartUpWorkFlowSelection(workflow As IFM.VR.Common.Workflow.Workflow.WorkflowSection)
        If workflow = IFM.VR.Common.Workflow.Workflow.WorkflowSection.na AndAlso Me.ctl_WorkflowManager_Quote_Farm.CurrentWorkFlow = IFM.VR.Common.Workflow.Workflow.WorkflowSection.na Then
            Me.ctl_WorkflowManager_Quote_Farm.CurrentWorkFlow = IFM.VR.Common.Workflow.Workflow.WorkflowSection.policyHolders
        End If
    End Sub
End Class