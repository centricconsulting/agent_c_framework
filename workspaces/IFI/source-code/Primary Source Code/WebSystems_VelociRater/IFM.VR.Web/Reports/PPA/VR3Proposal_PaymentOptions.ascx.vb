...
Partial Class VR3Proposal_PaymentOptions
    ...
    Public Property DirectMonthlyPremiumTotal As String
        Get
            Return Me.lblMonthly_PremiumTotal.Text
        End Get
        Set(value As String)
            Me.lblMonthly_PremiumTotal.Text = value
        End Set
    End Property
    ...
    'Added 6/14/2019 for Bug 31360 MLW
    Public Property DirectQuarterlyPremiumTotal As String
        Get
            Return Me.lblQuarterly_PremiumTotal.Text
        End Get
        Set(value As String)
            Me.lblQuarterly_PremiumTotal.Text = value
        End Set
    End Property
    ...
    'Added 6/14/2019 for Bug 31360 MLW
    Public Property DirectSemiAnnualPremiumTotal As String
        Get
            Return Me.lblSemiAnnual_PremiumTotal.Text
        End Get
        Set(value As String)
            Me.lblSemiAnnual_PremiumTotal.Text = value
        End Set
    End Property
    ...
    'Added 6/14/2019 for Bug 31360 MLW
    Public Property DirectAnnualPremiumTotal As String
        Get
            Return Me.lblAnnual_PremiumTotal.Text
        End Get
        Set(value As String)
            Me.lblAnnual_PremiumTotal.Text = value
        End Set
    End Property
    ...
    'Added 6/14/2019 for Bug 31360 MLW
    Public Property RenewalCreditPremiumTotal As String
        Get
            Return Me.lblRenewalCreditCardMonthly_PremiumTotal.Text
        End Get
        Set(value As String)
            Me.lblRenewalCreditCardMonthly_PremiumTotal.Text = value
        End Set
    End Property
    ...
    'Added 6/14/2019 for Bug 31360 MLW
    Public Property RenewalEftPremiumTotal As String
        Get
            Return Me.lblRenewalEftMonthly_PremiumTotal.Text
        End Get
        Set(value As String)
            Me.lblRenewalEftMonthly_PremiumTotal.Text = value
        End Set
    End Property
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        If Page.IsPostBack = False Then
            If IFM.VR.Common.Helpers.PPA.RccOptionHelper.IsShowRCCBillingPayPlanDate() = False Then
                RccMonthlyToRemove.Visible = False
            End If
        End If
    End Sub
End Class