//http://www.thoughtdelimited.org/dirtyFields/documentation.cfm#callbacks
...
(function ($) {
    $.fn.dirtyFields = function (parameters) {
        ...
        return this.each(function () {
            ...
            $("input[type='text'],input[type='number'],input[type='search'],input[type='email'],input[type='url'],input[type='tel'],input[type='file'],input[type='password'],textarea", $container).not("." + $container.data("dF").exclusionClass).each(function (i) {
    ...
    $.fn.dirtyFields.setStartingValues = function ($container, opts) {
        $("input[type='text'],input[type='number'],input[type='search'],input[type='email'],input[type='url'],input[type='tel'],input[type='file'],input[type='password'],:checkbox,:radio,textarea", $container).not("." + $container.data("dF").exclusionClass).each(function (i) {
            var $object = $(this);
