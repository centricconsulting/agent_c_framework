<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/VelociRater.Master" CodeBehind="VR3360ValueReturn.aspx.vb" Inherits="IFM.VR.Web.VR3360ValueReturn" %>
            ...
            <td style="vertical-align: top;">
                <div>
                    <asp:Panel ID="pnlMain" runat="server">
                        <asp:Label ID="lblMsg" runat="server" ForeColor="Red" Font-Bold="true" Text="360Value Error Has Occured, Being Redirected Back To VelociRater"></asp:Label>
                    </asp:Panel>
                </div>
            </td>
        </tr>
