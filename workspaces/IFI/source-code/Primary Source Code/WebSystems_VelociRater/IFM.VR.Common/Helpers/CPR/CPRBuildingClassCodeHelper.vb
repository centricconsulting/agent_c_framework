...
Namespace IFM.VR.Common.Helpers.CPR
    ...
    Public Class CPRBuildingClassCodeHelper
        Public Shared Function BuildingClassCodeIsYardRateEligible(ByVal ClassCode As String) As Boolean
            If ClassCode = "1400" OrElse ClassCode = "1650" OrElse ClassCode = "1700" Then Return True Else Return False
        End Function

        Public Shared Function GetClassCodes(SearchTypeid As String, searchString As String, lob As String, ProgramTypeId As String) As List(Of CPRBuildingClassCodeLookupResult)
            Dim results As New List(Of CPRBuildingClassCodeLookupResult)
            ...
            Using conn As New System.Data.SqlClient.SqlConnection(AppSettings("connQQ"))
                Using cmd As New System.Data.SqlClient.SqlCommand()
                    ...
                    cmd.CommandText = "usp_CPR_Search_ClassCodes"
                    ...
                    Using reader As System.Data.SqlClient.SqlDataReader = cmd.ExecuteReader()
                        If reader.HasRows Then
                            While reader.Read()
                                Dim cc As New CPRBuildingClassCodeLookupResult()
                                ...
                                For Each c As CPRBuildingClassCodeLookupResult In results
    ...
    Public Class CPRBuildingClassCodeLookupResult
